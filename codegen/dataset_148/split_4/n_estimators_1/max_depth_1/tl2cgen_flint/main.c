...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40400000))) ) ) {
    ...
    result[3] += 0;
    result[4] += 0.0001541782300339192;
    result[5] += 0;
    result[6] += 0;
  } else {
    result[0] += 0.4644565960355434;
    result[1] += 0.001367053998632946;
    result[2] += 0.006379585326953748;
    result[3] += 0.3873319662793347;
    result[4] += 0.13932558669400774;
    result[5] += 0.000683526999316473;
    result[6] += 0.000455684666210982;
  }
