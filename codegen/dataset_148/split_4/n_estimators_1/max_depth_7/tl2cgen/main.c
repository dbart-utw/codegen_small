          ...
          if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)87.5) ) ) {
            if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)47) ) ) {
              if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)43) ) ) {
                result[0] += 0.9969301611665388;
                result[1] += 0;
                result[2] += 0.0030698388334612432;
                result[3] += 0;
                result[4] += 0;
                result[5] += 0;
                result[6] += 0;
          ...
          if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)40.5) ) ) {
            if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)29) ) ) {
              if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)27) ) ) {
                result[0] += 0.988988988988989;
                result[1] += 0;
                result[2] += 0.01001001001001001;
                result[3] += 0;
                result[4] += 0;
                result[5] += 0;
                result[6] += 0.001001001001001001;
              } else {
                result[0] += 0.9640883977900553;
              ...
              if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)33.5) ) ) {
                ...
                result[0] += 0.998396579369321;
                result[1] += 0.0001781578478531979;
                result[2] += 0.0010689470871191873;
                result[3] += 0.0001781578478531979;
                result[4] += 0;
                result[5] += 0;
                result[6] += 0.0001781578478531979;
              }
            }
          } else {
            if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)45.5) ) ) {
              ...
              if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
                ...
                result[0] += 0.9986419194205522;
                result[1] += 0;
                result[2] += 0.001358080579447714;
                result[3] += 0;
                result[4] += 0;
                result[5] += 0;
                result[6] += 0;
          ...
          if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
            if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)62.5) ) ) {
              ...
              if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)93.5) ) ) {
                ...
                result[0] += 0.9701657458563536;
                result[1] += 0;
                result[2] += 0.009944751381215469;
                result[3] += 0.014364640883977901;
                result[4] += 0;
                result[5] += 0.0011049723756906078;
                result[6] += 0.004419889502762431;
              }
            }
          } else {
            if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)33) ) ) {
              if ( ( !(data[1].missing != -1) || (data[1].fvalue <= (float)65) ) ) {
                result[0] += 0.9271255060728745;
                result[1] += 0;
                result[2] += 0.003148897885739991;
                result[3] += 0.06972559604138552;
                result[4] += 0;
                result[5] += 0;
                result[6] += 0;
              } else {
