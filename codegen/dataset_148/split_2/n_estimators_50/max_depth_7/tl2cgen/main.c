...
void predict(union Entry* data, int pred_margin, float* result) {
    ...
    if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)80.5) ) ) {
      if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
        ...
        if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)99) ) ) {
          ...
          if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-5236.5) ) ) {
            result[0] += 0;
            result[1] += 0;
            result[2] += 0;
            result[3] += 1;
    ...
    if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)81.5) ) ) {
      ...
      if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)27) ) ) {
        if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)61) ) ) {
          ...
          if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)14) ) ) {
            result[0] += 0;
            result[1] += 0;
            result[2] += 0;
            result[3] += 0;
  ...
  if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)25.5) ) ) {
    if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)81) ) ) {
      if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)7.5) ) ) {
        if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)14) ) ) {
          if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)4044) ) ) {
            result[0] += 1;
            result[1] += 0;
            result[2] += 0;
            result[3] += 0;
      ...
      if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)110) ) ) {
        ...
        if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)7.5) ) ) {
          ...
          if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)156) ) ) {
            ...
            if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)220) ) ) {
              result[0] += 1;
              result[1] += 0;
              result[2] += 0;
              result[3] += 0;
    ...
    if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)82.5) ) ) {
      if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)115.5) ) ) {
        ...
        if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)-39) ) ) {
          if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)81.5) ) ) {
            if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-1486.5) ) ) {
              if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)254.5) ) ) {
                result[0] += 1;
                result[1] += 0;
                result[2] += 0;
                result[3] += 0;
      ...
      if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
        ...
        if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)15.5) ) ) {
          ...
          if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)97) ) ) {
            ...
            if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-5229.5) ) ) {
              result[0] += 0;
              result[1] += 0;
              result[2] += 0;
              result[3] += 1;
    ...
    if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)25.5) ) ) {
      if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)81.5) ) ) {
        if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
          ...
          if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)-35) ) ) {
            if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)183) ) ) {
              result[0] += 0;
              result[1] += 0;
              result[2] += 0;
              result[3] += 0;
    ...
    if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)59.5) ) ) {
      ...
      if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
        if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)48) ) ) {
          ...
          if ( ( !(data[1].missing != -1) || (data[1].fvalue <= (float)23.5) ) ) {
            if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)105.5) ) ) {
              result[0] += 1;
              result[1] += 0;
              result[2] += 0;
