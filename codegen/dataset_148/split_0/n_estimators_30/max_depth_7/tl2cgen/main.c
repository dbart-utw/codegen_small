      ...
      if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)-39) ) ) {
        if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)109) ) ) {
          if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)24) ) ) {
            ...
            if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-1485) ) ) {
              result[0] += 1;
              result[1] += 0;
              result[2] += 0;
              result[3] += 0;
  ...
  if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)23.5) ) ) {
    if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)7) ) ) {
      if ( ( !(data[1].missing != -1) || (data[1].fvalue <= (float)-2306.5) ) ) {
        ...
        if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-4.5) ) ) {
          if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)18) ) ) {
            result[0] += 1;
            result[1] += 0;
            result[2] += 0;
            result[3] += 0;
      ...
      if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)99.5) ) ) {
        ...
        if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)69) ) ) {
          if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)33.5) ) ) {
            ...
            if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)144) ) ) {
              result[0] += 0;
              result[1] += 0;
              result[2] += 0;
              result[3] += 0;
      ...
      if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)4.5) ) ) {
        ...
        if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)99.5) ) ) {
          ...
          if ( ( !(data[1].missing != -1) || (data[1].fvalue <= (float)0.5) ) ) {
            ...
            if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)68) ) ) {
    ...
    if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)81) ) ) {
      ...
      if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)87) ) ) {
        ...
        if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)212) ) ) {
          ...
          if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)255) ) ) {
            result[0] += 0;
            result[1] += 0;
            result[2] += 0;
            result[3] += 1;
      ...
      if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)7.5) ) ) {
        ...
        if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)24) ) ) {
          ...
          if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-1486) ) ) {
            if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)-174) ) ) {
              result[0] += 0;
              result[1] += 0;
              result[2] += 0;
              result[3] += 1;
