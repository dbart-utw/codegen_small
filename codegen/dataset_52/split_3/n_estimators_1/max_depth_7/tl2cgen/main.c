    ...
    if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2315400019288063049) ) ) {
      if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)-0.1813500020653009415) ) ) {
        if ( UNLIKELY( !(data[33].missing != -1) || (data[33].fvalue <= (float)0.06078499555587768555) ) ) {
          if ( UNLIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)0.2242500036954879761) ) ) {
            result[0] += 1;
            result[1] += 0;
          } else {
            result[0] += 0;
      ...
      if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)0.5) ) ) {
        ...
        if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.9622650146484375) ) ) {
          ...
          if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.9872500002384185791) ) ) {
            ...
            if ( LIKELY( !(data[10].missing != -1) || (data[10].fvalue <= (float)0.8363850116729736328) ) ) {
              if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.4181150048971176147) ) ) {
                result[0] += 0.1;
                result[1] += 0.9;
              } else {
                result[0] += 0;
              ...
              if ( UNLIKELY( !(data[10].missing != -1) || (data[10].fvalue <= (float)0.8539800047874450684) ) ) {
                result[0] += 1;
                result[1] += 0;
              } else {
                result[0] += 0.0625;
