...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)-0.9361749887466430664) ) ) {
    if ( LIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.9144749939441680908) ) ) {
      ...
      if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
        result[0] += 1;
  ...
  if ( LIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9999450147151947021) ) ) {
    if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.2920700013637542725) ) ) {
      if ( LIKELY( !(data[18].missing != -1) || (data[18].fvalue <= (float)-0.1398250013589859009) ) ) {
      ...
      if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)-0.1022850126028060913) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
    ...
    if ( LIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.04778499901294708252) ) ) {
      if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.03555500134825706482) ) ) {
  ...
  if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2315400019288063049) ) ) {
    if ( LIKELY( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.4054549932479858398) ) ) {
      ...
      if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.7366849929094314575) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
        result[0] += 1;
  ...
  if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.2192749977111816406) ) ) {
    ...
    if ( LIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9999450147151947021) ) ) {
      if ( UNLIKELY( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.01154499966651201248) ) ) {
  ...
  if ( LIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9999450147151947021) ) ) {
    if ( UNLIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.01111999992281198502) ) ) {
      if ( LIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.2245049998164176941) ) ) {
        result[0] += 0.65625;
        result[1] += 0.34375;
      } else {
        result[0] += 0;
    ...
    if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)0.5) ) ) {
      ...
      if ( LIKELY( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.6929800212383270264) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
