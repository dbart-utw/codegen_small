...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)-0.9257999956607818604) ) ) {
    if ( LIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.362630009651184082) ) ) {
      ...
      if ( UNLIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)0) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
        result[0] += 1;
  ...
  if ( UNLIKELY( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.07206000015139579773) ) ) {
    if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.2874100059270858765) ) ) {
      ...
      if ( LIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.7807300090789794922) ) ) {
    ...
    if ( LIKELY( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.9988799989223480225) ) ) {
      ...
      if ( LIKELY( !(data[33].missing != -1) || (data[33].fvalue <= (float)0.2857000008225440979) ) ) {
  ...
  if ( UNLIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)-0.9561049938201904297) ) ) {
    ...
    if ( LIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)0.8927049934864044189) ) ) {
      if ( UNLIKELY( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.1359499990940093994) ) ) {
        if ( LIKELY( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.4480850100517272949) ) ) {
          ...
          if ( LIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.6269599944353103638) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 1;
  ...
  if ( UNLIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.0569800008088350296) ) ) {
    if ( LIKELY( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.4197400063276290894) ) ) {
      if ( UNLIKELY( !(data[33].missing != -1) || (data[33].fvalue <= (float)-0.180895000696182251) ) ) {
        if ( LIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)-0.09668999654240906239) ) ) {
        ...
        if ( UNLIKELY( !(data[17].missing != -1) || (data[17].fvalue <= (float)-0.008879999630153179169) ) ) {
      ...
      if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.1020400002598762512) ) ) {
        ...
        if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.07190000265836715698) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
  ...
  if ( UNLIKELY( !(data[17].missing != -1) || (data[17].fvalue <= (float)-0.7614249885082244873) ) ) {
    ...
    if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.198045000433921814) ) ) {
      if ( UNLIKELY( !(data[18].missing != -1) || (data[18].fvalue <= (float)-0.1497700028121471405) ) ) {
      ...
      if ( LIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.8371500074863433838) ) ) {
        ...
        if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.9503299891948699951) ) ) {
          if ( LIKELY( !(data[10].missing != -1) || (data[10].fvalue <= (float)0.9056049883365631104) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 1;
