  ...
  if ( UNLIKELY( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.03839499969035387039) ) ) {
    if ( LIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.1299249976873397827) ) ) {
      if ( UNLIKELY( !(data[29].missing != -1) || (data[29].fvalue <= (float)-0.3326049931347370148) ) ) {
        if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.1130099967122077942) ) ) {
          result[0] += 0;
          result[1] += 1;
        } else {
          if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)-0.4071100056171417236) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 1;
        ...
        if ( UNLIKELY( !(data[12].missing != -1) || (data[12].fvalue <= (float)-0.04230500012636184692) ) ) {
          if ( LIKELY( !(data[12].missing != -1) || (data[12].fvalue <= (float)-0.5236249994486570358) ) ) {
            result[0] += 1;
            result[1] += 0;
          } else {
            result[0] += 0;
