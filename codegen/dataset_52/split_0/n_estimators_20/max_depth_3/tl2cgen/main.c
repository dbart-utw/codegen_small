...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.0009850000496953725815) ) ) {
    if ( ( !(data[12].missing != -1) || (data[12].fvalue <= (float)0.3341400027275085449) ) ) {
      ...
      if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.4119849950075149536) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
  ...
  if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.0001250000059371814132) ) ) {
    if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.06735000014305114746) ) ) {
      ...
      if ( ( !(data[17].missing != -1) || (data[17].fvalue <= (float)0.5133249908685684204) ) ) {
  ...
  if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.02660499978810548782) ) ) {
    if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.1278200037777423859) ) ) {
    ...
    if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.4330900013446807861) ) ) {
      if ( ( !(data[25].missing != -1) || (data[25].fvalue <= (float)-0.5208849906921386719) ) ) {
        result[0] += 0.75;
        result[1] += 0.25;
      } else {
        result[0] += 1;
  ...
  if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5176050066947937012) ) ) {
    ...
    if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2315400019288063049) ) ) {
      if ( ( !(data[9].missing != -1) || (data[9].fvalue <= (float)0.6349649876356124878) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        result[0] += 0.8;
  ...
  if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.1902799978852272034) ) ) {
    ...
    if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)-0.8275400102138519287) ) ) {
      if ( ( !(data[19].missing != -1) || (data[19].fvalue <= (float)0.5231299847364425659) ) ) {
  ...
  if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5176050066947937012) ) ) {
    if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.586044996976852417) ) ) {
      if ( ( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.1390749961137771606) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        result[0] += 0;
  ...
  if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.007985000032931566238) ) ) {
    ...
    if ( ( !(data[17].missing != -1) || (data[17].fvalue <= (float)0.6893749833106994629) ) ) {
  ...
  if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2315400019288063049) ) ) {
    if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.2350400015711784363) ) ) {
      ...
      if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)-0.0774250030517578125) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        result[0] += 0;
  ...
  if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.6283050179481506348) ) ) {
    if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.6831599920988082886) ) ) {
      if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.9240849912166595459) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
  ...
  if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)0.9443449974060058594) ) ) {
    if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.07860999926924705505) ) ) {
      if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.8579450249671936035) ) ) {
