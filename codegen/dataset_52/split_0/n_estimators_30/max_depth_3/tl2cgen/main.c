...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.1740150004625320435) ) ) {
    if ( ( !(data[11].missing != -1) || (data[11].fvalue <= (float)0.04340999945998191833) ) ) {
      if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.2608799971640110016) ) ) {
  ...
  if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.1832699999213218689) ) ) {
    ...
    if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.4870300143957138062) ) ) {
      if ( ( !(data[27].missing != -1) || (data[27].fvalue <= (float)-0.2420649975538253784) ) ) {
        result[0] += 0.375;
        result[1] += 0.625;
      } else {
        result[0] += 1;
  ...
  if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.02937499992549419403) ) ) {
    if ( ( !(data[33].missing != -1) || (data[33].fvalue <= (float)-0.1482399990782141685) ) ) {
      if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)-0.1303550004959106445) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        result[0] += 0;
  ...
  if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9959399998188018799) ) ) {
    ...
    if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)0.9534899890422821045) ) ) {
      ...
      if ( ( !(data[19].missing != -1) || (data[19].fvalue <= (float)0.4196799919009208679) ) ) {
        result[0] += 0.5263157894736842;
        result[1] += 0.47368421052631576;
      } else {
        result[0] += 1;
  ...
  if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.02937499992549419403) ) ) {
    if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)-0.1111399959772825241) ) ) {
