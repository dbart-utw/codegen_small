...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[33].missing != -1) || (data[33].fvalue <= (float)-2.999999924213625491e-05) ) ) {
    if ( ( !(data[33].missing != -1) || (data[33].fvalue <= (float)-0.9481050074100494385) ) ) {
      ...
      if ( ( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.5279300063848495483) ) ) {
    ...
    if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.0579400012647965923) ) ) {
      ...
      if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.6914650052785873413) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
  ...
  if ( ( !(data[27].missing != -1) || (data[27].fvalue <= (float)0.8312600255012512207) ) ) {
    if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.1321949958801269531) ) ) {
      ...
      if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.3594450056552886963) ) ) {
  ...
  if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.4474650025367736816) ) ) {
    if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.1679600030183792114) ) ) {
      ...
      if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.607215002179145813) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
        result[0] += 1;
  ...
  if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.3010550141334533691) ) ) {
    ...
    if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)0.158195003867149353) ) ) {
      if ( ( !(data[21].missing != -1) || (data[21].fvalue <= (float)-0.8475250005722045898) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
        result[0] += 1;
  ...
  if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.08240000158548355103) ) ) {
    if ( ( !(data[11].missing != -1) || (data[11].fvalue <= (float)0.3919499963521957397) ) ) {
      if ( ( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.2041000016033649445) ) ) {
