...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.001044999997247941792) ) ) {
    if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.7250399887561798096) ) ) {
      ...
      if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)-0.1148650050163269043) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
  ...
  if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.1482750028371810913) ) ) {
    if ( ( !(data[9].missing != -1) || (data[9].fvalue <= (float)-0.04962500184774398804) ) ) {
    ...
    if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.03596000000834465027) ) ) {
      ...
      if ( ( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.1153700016438961029) ) ) {
  ...
  if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.03839499969035387039) ) ) {
    if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.05426999833434820175) ) ) {
      if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.1339449957013130188) ) ) {
        result[0] += 0.8;
        result[1] += 0.2;
      } else {
        result[0] += 1;
  ...
  if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.05749000143259763718) ) ) {
    if ( ( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.05559000000357627869) ) ) {
      if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.847220003604888916) ) ) {
        result[0] += 0.98;
        result[1] += 0.02;
      } else {
        result[0] += 0;
  ...
  if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2356900051236152649) ) ) {
    ...
    if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)-0.8275400102138519287) ) ) {
      if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)-0.3803200125694274902) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
        result[0] += 1;
