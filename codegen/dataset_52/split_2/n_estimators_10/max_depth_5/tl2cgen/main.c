...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.2495149970054626465) ) ) {
    if ( ( !(data[25].missing != -1) || (data[25].fvalue <= (float)-0.0004499999922700226307) ) ) {
      if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)-0.0008299999753944575787) ) ) {
        ...
        if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)-0.185234997421503067) ) ) {
          if ( ( !(data[29].missing != -1) || (data[29].fvalue <= (float)0.4040749967098236084) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 1;
      ...
      if ( ( !(data[11].missing != -1) || (data[11].fvalue <= (float)0.7886150181293487549) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.3360149860382080078) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
          result[0] += 0;
    ...
    if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)-0.8071799874305725098) ) ) {
      ...
      if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)0.1882999949157238007) ) ) {
        if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.772145003080368042) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
          result[0] += 0;
  ...
  if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.297214999794960022) ) ) {
    if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.4105599969625473022) ) ) {
      result[0] += 1;
      result[1] += 0;
    } else {
    ...
    if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.6929800212383270264) ) ) {
      ...
      if ( ( !(data[19].missing != -1) || (data[19].fvalue <= (float)-0.7356050014495849609) ) ) {
        ...
        if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.7295950055122375488) ) ) {
          if ( ( !(data[24].missing != -1) || (data[24].fvalue <= (float)-0.07778000831604003906) ) ) {
            result[0] += 1;
            result[1] += 0;
          } else {
  ...
  if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.2207150012254714966) ) ) {
    if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.3475300073623657227) ) ) {
      ...
      if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.4373750090599060059) ) ) {
  ...
  if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)0.5) ) ) {
    ...
    if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.1321949958801269531) ) ) {
      if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)-0.0002350000049773370847) ) ) {
        if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.646474987268447876) ) ) {
        ...
        if ( ( !(data[21].missing != -1) || (data[21].fvalue <= (float)-0.4073799997568130493) ) ) {
  ...
  if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9959399998188018799) ) ) {
    if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.5303899943828582764) ) ) {
      result[0] += 1;
      result[1] += 0;
    } else {
    ...
    if ( ( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.5806550011038780212) ) ) {
      ...
      if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.01052500028163194656) ) ) {
        ...
        if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.4907549917697906494) ) ) {
          ...
          if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.2368350066244602203) ) ) {
            result[0] += 1;
            result[1] += 0;
          } else {
            result[0] += 0;
  ...
  if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.0002000000094994902611) ) ) {
    ...
    if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.3557550013065338135) ) ) {
      if ( ( !(data[27].missing != -1) || (data[27].fvalue <= (float)-0.3499699942767620087) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
      ...
      if ( ( !(data[10].missing != -1) || (data[10].fvalue <= (float)-0.4833500087261199951) ) ) {
        ...
        if ( ( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.159045003354549408) ) ) {
          ...
          if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.7517099976539611816) ) ) {
            result[0] += 0.9;
            result[1] += 0.1;
          } else {
            result[0] += 0;
