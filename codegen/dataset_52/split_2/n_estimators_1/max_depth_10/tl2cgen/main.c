        ...
        if ( ( !(data[33].missing != -1) || (data[33].fvalue <= (float)0.8989500105381011963) ) ) {
          if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.1459750011563301086) ) ) {
            ...
            if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)0.7483049929141998291) ) ) {
              if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9300700128078460693) ) ) {
                if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)-0.6698200106620788574) ) ) {
                  ...
                  if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)-0.03878999873995780945) ) ) {
                    if ( ( !(data[24].missing != -1) || (data[24].fvalue <= (float)-0.05805000104010105133) ) ) {
                      result[0] += 0;
                      result[1] += 1;
                    } else {
                      result[0] += 1;
                ...
                if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.7301650047302246094) ) ) {
              ...
              if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.3413350135087966919) ) ) {
                result[0] += 0;
                result[1] += 1;
              } else {
                result[0] += 1;
