    ...
    if ( ( !(data[19].missing != -1) || (data[19].fvalue <= (float)0.3836050033569335938) ) ) {
      if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)-0.009365000063553452492) ) ) {
        if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9299900233745574951) ) ) {
          if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)-0.01496999990195035934) ) ) {
      ...
      if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.5415849983692169189) ) ) {
        if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.1995149999856948853) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
    ...
    if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)-0.8314950168132781982) ) ) {
      if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)-0.5224250108003616333) ) ) {
        ...
        if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)-0.2583499997854232788) ) ) {
          if ( ( !(data[33].missing != -1) || (data[33].fvalue <= (float)-0.06760001182556152344) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 1;
        ...
        if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)0.7107249796390533447) ) ) {
          if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.1860899999737739563) ) ) {
            ...
            if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.1456900015473365784) ) ) {
              if ( ( !(data[31].missing != -1) || (data[31].fvalue <= (float)-0.2824000045657157898) ) ) {
