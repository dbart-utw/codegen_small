...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2630599960684776306) ) ) {
    if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.005030000116676092148) ) ) {
      ...
      if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.01067000022158026695) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
  ...
  if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.186569996178150177) ) ) {
    if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)-0.01614999957382678986) ) ) {
      if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.06239500176161527634) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
      ...
      if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)-0.2663749903440475464) ) ) {
        result[0] += 0.625;
        result[1] += 0.375;
      } else {
  ...
  if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.186569996178150177) ) ) {
    if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.1688899993896484375) ) ) {
      ...
      if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.2029249966144561768) ) ) {
  ...
  if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.9992100000381469727) ) ) {
    if ( ( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.1256750002503395081) ) ) {
      ...
      if ( ( !(data[14].missing != -1) || (data[14].fvalue <= (float)-0.9831550121307373047) ) ) {
        result[0] += 0.6666666666666666;
        result[1] += 0.3333333333333333;
      } else {
  ...
  if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.2200950011610984802) ) ) {
    if ( ( !(data[24].missing != -1) || (data[24].fvalue <= (float)-0.14473000168800354) ) ) {
      if ( ( !(data[29].missing != -1) || (data[29].fvalue <= (float)0.6432799994945526123) ) ) {
  ...
  if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.6283050179481506348) ) ) {
    if ( ( !(data[17].missing != -1) || (data[17].fvalue <= (float)-0.7840449810028076172) ) ) {
      if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.1455949991941452026) ) ) {
        result[0] += 0.5;
        result[1] += 0.5;
      } else {
        result[0] += 1;
  ...
  if ( ( !(data[12].missing != -1) || (data[12].fvalue <= (float)0.05720999930053949356) ) ) {
    if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)-0.09156499989330768585) ) ) {
      if ( ( !(data[10].missing != -1) || (data[10].fvalue <= (float)-0.09487999975681304932) ) ) {
        result[0] += 0.15;
        result[1] += 0.85;
      } else {
      ...
      if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.3904900029301643372) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        result[0] += 0.6;
