...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.4369300007820129395) ) ) {
    if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)-0.0205449995119124651) ) ) {
      if ( LIKELY( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.3959449976682662964) ) ) {
        if ( UNLIKELY( !(data[31].missing != -1) || (data[31].fvalue <= (float)-0.01131000020541250706) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
          if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)-0.3441400080919265747) ) ) {
            result[0] += 1;
            result[1] += 0;
          } else {
            result[0] += 0;
