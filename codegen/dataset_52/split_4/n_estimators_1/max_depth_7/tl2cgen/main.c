...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.08850499987602233887) ) ) {
    if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.01812000013887882233) ) ) {
      if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.4769899882376194) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
      ...
      if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.1978349983692169189) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
      ...
      if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.07985000312328338623) ) ) {
        ...
        if ( UNLIKELY( !(data[17].missing != -1) || (data[17].fvalue <= (float)-0.7509149909019470215) ) ) {
          ...
          if ( LIKELY( !(data[17].missing != -1) || (data[17].fvalue <= (float)0.6834149956703186035) ) ) {
            ...
            if ( UNLIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.9267849922180175781) ) ) {
              result[0] += 1;
              result[1] += 0;
            } else {
              result[0] += 0;
