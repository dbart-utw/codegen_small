...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.08204999938607215881) ) ) {
    if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.05172500014305114746) ) ) {
      ...
      if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8705250024795532227) ) ) {
        if ( ( !(data[11].missing != -1) || (data[11].fvalue <= (float)0.122835010290145874) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
          result[0] += 0;
    ...
    if ( ( !(data[0].missing != -1) || (data[0].fvalue <= (float)0.5) ) ) {
      ...
      if ( ( !(data[17].missing != -1) || (data[17].fvalue <= (float)-0.7446549832820892334) ) ) {
        ...
        if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)-0.9092949926853179932) ) ) {
          ...
          result[0] += 0.09844559585492228;
          result[1] += 0.9015544041450777;
        }
      }
    }
  }
  ...
  if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.1205449998378753662) ) ) {
    if ( ( !(data[16].missing != -1) || (data[16].fvalue <= (float)-0.05518000014126300812) ) ) {
      ...
      if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)-0.3266150057315826416) ) ) {
        if ( ( !(data[17].missing != -1) || (data[17].fvalue <= (float)0.4614700078964233398) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
          result[0] += 0;
  ...
  if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.1768100038170814514) ) ) {
    if ( ( !(data[11].missing != -1) || (data[11].fvalue <= (float)0.3645649999380111694) ) ) {
      if ( ( !(data[33].missing != -1) || (data[33].fvalue <= (float)-0.170329999178647995) ) ) {
        if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.5664499998092651367) ) ) {
          result[0] += 0;
          result[1] += 1;
        } else {
          result[0] += 1;
