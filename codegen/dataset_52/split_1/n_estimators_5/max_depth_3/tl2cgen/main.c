...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.2129049971699714661) ) ) {
    if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.2877649962902069092) ) ) {
      ...
      if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.5997000038623809814) ) ) {
  ...
  if ( UNLIKELY( !(data[11].missing != -1) || (data[11].fvalue <= (float)-0.3173149973154067993) ) ) {
    if ( UNLIKELY( !(data[10].missing != -1) || (data[10].fvalue <= (float)0.717220008373260498) ) ) {
      result[0] += 1;
      result[1] += 0;
    } else {
      if ( UNLIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)-0.4946500062942504883) ) ) {
        result[0] += 0.25;
        result[1] += 0.75;
      } else {
        result[0] += 0.9;
  ...
  if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.06247999891638755798) ) ) {
  ...
  if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.01699000038206577301) ) ) {
    ...
    if ( UNLIKELY( !(data[11].missing != -1) || (data[11].fvalue <= (float)-0.3112450093030929565) ) ) {
      if ( LIKELY( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.6495400071144104004) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        result[0] += 0.6666666666666666;
