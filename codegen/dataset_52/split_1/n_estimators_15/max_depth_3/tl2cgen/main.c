...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2315400019288063049) ) ) {
    if ( UNLIKELY( !(data[8].missing != -1) || (data[8].fvalue <= (float)-0.1673249974846839905) ) ) {
      if ( LIKELY( !(data[33].missing != -1) || (data[33].fvalue <= (float)0.1023399978876113892) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        result[0] += 0.2;
  ...
  if ( LIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.9236549735069274902) ) ) {
    if ( UNLIKELY( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.02214000001549720764) ) ) {
      if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)-0.04442000016570091248) ) ) {
    ...
    if ( UNLIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.6568950116634368896) ) ) {
  ...
  if ( UNLIKELY( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.05176999978721141815) ) ) {
    if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.06986000016331672668) ) ) {
    ...
    if ( LIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.9921000003814697266) ) ) {
  ...
  if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.2315400019288063049) ) ) {
    if ( UNLIKELY( !(data[18].missing != -1) || (data[18].fvalue <= (float)-0.2104850038886070251) ) ) {
    ...
    if ( LIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.9570200145244598389) ) ) {
      ...
      if ( UNLIKELY( !(data[31].missing != -1) || (data[31].fvalue <= (float)-0.211129993200302124) ) ) {
        result[0] += 0.5;
        result[1] += 0.5;
      } else {
        result[0] += 1;
