...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.009805000387132167816) ) ) {
    ...
    if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)0.4287499934434890747) ) ) {
      if ( UNLIKELY( !(data[23].missing != -1) || (data[23].fvalue <= (float)-0.07690499944146722555) ) ) {
        if ( UNLIKELY( !(data[31].missing != -1) || (data[31].fvalue <= (float)-0.1390700014308094978) ) ) {
          result[0] += 1;
          result[1] += 0;
        } else {
          result[0] += 0;
        ...
        if ( LIKELY( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.4603350162506103516) ) ) {
          ...
          if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)-0.2755099982023239136) ) ) {
            result[0] += 1;
            result[1] += 0;
          } else {
            result[0] += 0;
