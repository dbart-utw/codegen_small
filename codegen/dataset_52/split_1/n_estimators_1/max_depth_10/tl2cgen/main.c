...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.03717499971389770508) ) ) {
    if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)-0.1397199993953108788) ) ) {
        ...
        if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)-0.8071799874305725098) ) ) {
          ...
          if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)-0.3953550010919570923) ) ) {
            ...
            if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.81795501708984375) ) ) {
              if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.96096000075340271) ) ) {
                if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)0.7437599897384643555) ) ) {
                  if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)0.9759500026702880859) ) ) {
                    ...
                    if ( ( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.5403000116348266602) ) ) {
                      result[0] += 0;
                      result[1] += 1;
                    } else {
                      result[0] += 1;
              ...
              if ( ( !(data[9].missing != -1) || (data[9].fvalue <= (float)0.296870008111000061) ) ) {
                result[0] += 0;
                result[1] += 1;
              } else {
