      ...
      if ( ( !(data[31].missing != -1) || (data[31].fvalue <= (float)84) ) ) {
        ...
        if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)63.5) ) ) {
          ...
          if ( ( !(data[11].missing != -1) || (data[11].fvalue <= (float)101.5) ) ) {
            ...
            if ( ( !(data[16].missing != -1) || (data[16].fvalue <= (float)94.5) ) ) {
      ...
      if ( ( !(data[17].missing != -1) || (data[17].fvalue <= (float)65) ) ) {
        if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)103) ) ) {
          if ( ( !(data[21].missing != -1) || (data[21].fvalue <= (float)65) ) ) {
            if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)45.5) ) ) {
              result[0] += 0;
              result[1] += 1;
              result[2] += 0;
              result[3] += 0;
            ...
            if ( ( !(data[7].missing != -1) || (data[7].fvalue <= (float)58.5) ) ) {
              ...
              if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)85.5) ) ) {
                if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)71) ) ) {
                  result[0] += 0;
                  result[1] += 0;
                  result[2] += 0;
                  result[3] += 0;
        ...
        if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)101.5) ) ) {
          ...
          if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)86.5) ) ) {
            ...
            if ( ( !(data[1].missing != -1) || (data[1].fvalue <= (float)86.5) ) ) {
              ...
              if ( ( !(data[10].missing != -1) || (data[10].fvalue <= (float)130) ) ) {
      ...
      if ( ( !(data[2].missing != -1) || (data[2].fvalue <= (float)103) ) ) {
        ...
        if ( ( !(data[19].missing != -1) || (data[19].fvalue <= (float)78.5) ) ) {
          if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)88) ) ) {
            if ( ( !(data[11].missing != -1) || (data[11].fvalue <= (float)54.5) ) ) {
              result[0] += 0;
              result[1] += 0;
              result[2] += 1;
              result[3] += 0;
              ...
              if ( ( !(data[18].missing != -1) || (data[18].fvalue <= (float)124.5) ) ) {
                if ( ( !(data[3].missing != -1) || (data[3].fvalue <= (float)96) ) ) {
                  if ( ( !(data[22].missing != -1) || (data[22].fvalue <= (float)105.5) ) ) {
                    ...
                    if ( ( !(data[17].missing != -1) || (data[17].fvalue <= (float)112) ) ) {
                      result[0] += 0;
                      result[1] += 0;
                      result[2] += 1;
                      result[3] += 0;
