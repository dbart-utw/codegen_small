    ...
    if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.275324702262878418) ) ) {
      if ( ( !(data[12].missing != -1) || (data[12].fvalue <= (float)0.3819010108709335327) ) ) {
        ...
        if ( ( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.00176707742502912879) ) ) {
          if ( ( !(data[42].missing != -1) || (data[42].fvalue <= (float)0.00177719752537086606) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 1;
    ...
    if ( ( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.001762012368999421597) ) ) {
      if ( ( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.09138808771967887878) ) ) {
        ...
        if ( ( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.3487196117639541626) ) ) {
          if ( ( !(data[40].missing != -1) || (data[40].fvalue <= (float)0.7847184538841247559) ) ) {
            if ( ( !(data[69].missing != -1) || (data[69].fvalue <= (float)0.8184499442577362061) ) ) {
              if ( ( !(data[36].missing != -1) || (data[36].fvalue <= (float)0.7843354940414428711) ) ) {
                result[0] += 0.25;
                result[1] += 0.75;
              } else {
                result[0] += 0;
