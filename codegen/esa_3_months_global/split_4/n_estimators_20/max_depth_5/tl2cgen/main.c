...
void predict(union Entry* data, int pred_margin, float* result) {
    ...
    if ( ( !(data[58].missing != -1) || (data[58].fvalue <= (float)0.3217779546976089478) ) ) {
      if ( ( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.05921705067157745361) ) ) {
        ...
        if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.3460290580987930298) ) ) {
          if ( ( !(data[62].missing != -1) || (data[62].fvalue <= (float)0.9921150505542755127) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
  ...
  if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.275324702262878418) ) ) {
    if ( ( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1384864374995231628) ) ) {
      if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2413809299468994141) ) ) {
        result[0] += 1;
        result[1] += 0;
      } else {
        if ( ( !(data[72].missing != -1) || (data[72].fvalue <= (float)0.9059231579303741455) ) ) {
          if ( ( !(data[58].missing != -1) || (data[58].fvalue <= (float)0.2544422075152397156) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 0.25;
