...
void predict(union Entry* data, int pred_margin, float* result) {
        ...
        if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
          ...
          if ( ( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.4237040430307388306) ) ) {
            if ( ( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.06339415721595287323) ) ) {
              ...
              if ( ( !(data[46].missing != -1) || (data[46].fvalue <= (float)0.7023448348045349121) ) ) {
                result[0] += 0;
                result[1] += 1;
              } else {
  ...
  if ( ( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7603332698345184326) ) ) {
    ...
    if ( ( !(data[10].missing != -1) || (data[10].fvalue <= (float)0.3226326256990432739) ) ) {
      ...
      if ( ( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8173351287841796875) ) ) {
        if ( ( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.3499278873205184937) ) ) {
        ...
        if ( ( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.04389595240354537964) ) ) {
          if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.275324702262878418) ) ) {
            ...
            if ( ( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3181750625371932983) ) ) {
              result[0] += 0;
              result[1] += 1;
            } else {
              result[0] += 1;
        ...
        if ( ( !(data[31].missing != -1) || (data[31].fvalue <= (float)0.13653535395860672) ) ) {
          ...
          if ( ( !(data[23].missing != -1) || (data[23].fvalue <= (float)0.13653535395860672) ) ) {
            if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.2352908104658126831) ) ) {
              ...
              if ( ( !(data[40].missing != -1) || (data[40].fvalue <= (float)0.763606637716293335) ) ) {
