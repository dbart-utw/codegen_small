...
void predict(union Entry* data, int pred_margin, float* result) {
    ...
    if ( ( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.001762012368999421597) ) ) {
      if ( ( !(data[46].missing != -1) || (data[46].fvalue <= (float)0.7655960023403167725) ) ) {
        ...
        if ( ( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.7676883339881896973) ) ) {
          ...
          if ( ( !(data[40].missing != -1) || (data[40].fvalue <= (float)0.6698660552501678467) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
            result[0] += 1;
    ...
    if ( ( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2692928612232208252) ) ) {
      if ( ( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.1359096989035606384) ) ) {
        ...
        if ( ( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.7823984324932098389) ) ) {
          if ( ( !(data[45].missing != -1) || (data[45].fvalue <= (float)0.7331726551055908203) ) ) {
            result[0] += 0;
            result[1] += 1;
          } else {
      ...
      if ( ( !(data[45].missing != -1) || (data[45].fvalue <= (float)0.7342334985733032227) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
    ...
    if ( ( !(data[31].missing != -1) || (data[31].fvalue <= (float)0.1380424797534942627) ) ) {
      ...
      if ( ( !(data[58].missing != -1) || (data[58].fvalue <= (float)0.2852367013692855835) ) ) {
        if ( ( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.813657611608505249) ) ) {
          ...
          if ( ( !(data[4].missing != -1) || (data[4].fvalue <= (float)0.3811210691928863525) ) ) {
  ...
  if ( ( !(data[47].missing != -1) || (data[47].fvalue <= (float)0.7464606761932373047) ) ) {
    if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3600607514381408691) ) ) {
      ...
      if ( ( !(data[37].missing != -1) || (data[37].fvalue <= (float)0.7211062908172607422) ) ) {
        result[0] += 0;
        result[1] += 1;
      } else {
        if ( ( !(data[20].missing != -1) || (data[20].fvalue <= (float)0.203316807746887207) ) ) {
          result[0] += 0;
          result[1] += 1;
        } else {
          result[0] += 1;
  ...
  if ( ( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.275324702262878418) ) ) {
    if ( ( !(data[42].missing != -1) || (data[42].fvalue <= (float)0.001822743099182844162) ) ) {
      if ( ( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3600607514381408691) ) ) {
        ...
        if ( ( !(data[36].missing != -1) || (data[36].fvalue <= (float)0.7329269349575042725) ) ) {
          result[0] += 0;
          result[1] += 1;
        } else {
