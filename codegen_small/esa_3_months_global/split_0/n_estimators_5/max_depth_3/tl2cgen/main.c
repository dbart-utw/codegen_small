...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3528395742177963257) ) ) {
    if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7658493518829345703) ) ) {
      if ( UNLIKELY( !(data[9].missing != -1) || (data[9].fvalue <= (float)0.3532431274652481079) ) ) {
        result[0] += (float)0.2717557251908397;
        result[1] += (float)0.7282442748091603;
      } else {
        result[0] += (float)0.1026409144659046;
        result[1] += (float)0.8973590855340954;
      }
    } else {
      if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.7704465687274932861) ) ) {
        result[0] += (float)0.36231884057971014;
        result[1] += (float)0.6376811594202898;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
    ...
    if ( UNLIKELY( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.001762012368999421597) ) ) {
      if ( LIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8118190765380859375) ) ) {
        ...
        result[0] += (float)0.23655913978494625;
        result[1] += (float)0.7634408602150538;
      }
    } else {
      if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.2632576674222946167) ) ) {
        result[0] += (float)0.5851108322877457;
        result[1] += (float)0.4148891677122543;
      } else {
        result[0] += (float)0.9899229355531188;
        result[1] += (float)0.01007706444688113;
      }
    }
  }
  if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.389156639575958252) ) ) {
    ...
    if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.351395338773727417) ) ) {
      if ( UNLIKELY( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.8182544112205505371) ) ) {
        result[0] += (float)0.6966067864271457;
        result[1] += (float)0.3033932135728543;
      } else {
        result[0] += (float)0.004446678524476065;
        result[1] += (float)0.9955533214755239;
      }
    } else {
      if ( LIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.3460290580987930298) ) ) {
        result[0] += (float)0.9659321501043185;
        result[1] += (float)0.0340678498956815;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
  ...
  if ( UNLIKELY( !(data[56].missing != -1) || (data[56].fvalue <= (float)0.7128912806510925293) ) ) {
    if ( LIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.7768823504447937012) ) ) {
      ...
      if ( LIKELY( !(data[19].missing != -1) || (data[19].fvalue <= (float)0.3085954785346984863) ) ) {
    ...
    if ( LIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.2889022082090377808) ) ) {
      if ( UNLIKELY( !(data[31].missing != -1) || (data[31].fvalue <= (float)0.1380424797534942627) ) ) {
        result[0] += (float)0.9456509116246661;
        result[1] += (float)0.05434908837533387;
      } else {
        result[0] += (float)0.2957653592502603;
        result[1] += (float)0.7042346407497396;
      }
    } else {
      if ( UNLIKELY( !(data[31].missing != -1) || (data[31].fvalue <= (float)0.1501128673553466797) ) ) {
        result[0] += (float)0.5961538461538461;
        result[1] += (float)0.40384615384615385;
      } else {
        result[0] += (float)0.9987672384990265;
        result[1] += (float)0.0012327615009735358;
      }
    }
  }
  if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3528395742177963257) ) ) {
    ...
    if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7603332698345184326) ) ) {
      if ( LIKELY( !(data[45].missing != -1) || (data[45].fvalue <= (float)0.7432717978954315186) ) ) {
        result[0] += (float)0.002572347266881029;
        result[1] += (float)0.997427652733119;
      } else {
      ...
      if ( LIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.3468081206083297729) ) ) {
        result[0] += (float)0.9642928258519656;
        result[1] += (float)0.035707174148034364;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
  ...
  if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.3234125673770904541) ) ) {
    if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
      ...
      if ( UNLIKELY( !(data[58].missing != -1) || (data[58].fvalue <= (float)0.2304814010858535767) ) ) {
        ...
        result[0] += (float)0.9653412819188295;
        result[1] += (float)0.034658718081170506;
      }
    }
  } else {
    result[0] += (float)0;
