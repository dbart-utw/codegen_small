...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.8118190765380859375) ) ) {
    ...
    if ( LIKELY( !(data[10].missing != -1) || (data[10].fvalue <= (float)0.3226326256990432739) ) ) {
      if ( LIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.04389595240354537964) ) ) {
        result[0] += (float)0.9875433798349843;
        result[1] += (float)0.012456620165015744;
      } else {
        result[0] += (float)0.6244185159765119;
        result[1] += (float)0.3755814840234881;
      }
    } else {
      if ( UNLIKELY( !(data[23].missing != -1) || (data[23].fvalue <= (float)0.1380424797534942627) ) ) {
        result[0] += (float)0.9347826086956522;
        result[1] += (float)0.06521739130434782;
      } else {
        result[0] += (float)0.3272951832029642;
        result[1] += (float)0.6727048167970359;
      }
    }
  }
  if ( UNLIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.7750433683395385742) ) ) {
    ...
    if ( UNLIKELY( !(data[31].missing != -1) || (data[31].fvalue <= (float)0.1516199931502342224) ) ) {
      if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7676883339881896973) ) ) {
        result[0] += (float)0.9270565802786209;
        result[1] += (float)0.07294341972137909;
      } else {
        result[0] += (float)0.1781846894269815;
        result[1] += (float)0.8218153105730185;
      }
    } else {
      if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7695273160934448242) ) ) {
        result[0] += (float)0.9868317706543616;
        result[1] += (float)0.013168229345638407;
      } else {
        result[0] += (float)0.4590032154340836;
        result[1] += (float)0.5409967845659164;
      }
    }
  }
  if ( UNLIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8081411123275756836) ) ) {
    ...
    if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2692928612232208252) ) ) {
      if ( LIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1410631909966468811) ) ) {
        result[0] += (float)0.8445179495804601;
        result[1] += (float)0.1554820504195399;
      } else {
        result[0] += (float)0.19077574862791669;
        result[1] += (float)0.8092242513720833;
      }
    } else {
      if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.4284365326166152954) ) ) {
        result[0] += (float)0.6442048517520216;
        result[1] += (float)0.3557951482479784;
      } else {
        result[0] += (float)0.9989673377037768;
        result[1] += (float)0.0010326622962232408;
      }
    }
  }
  if ( LIKELY( !(data[8].missing != -1) || (data[8].fvalue <= (float)0.3653041869401931763) ) ) {
    if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1359096989035606384) ) ) {
      ...
      if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7676883339881896973) ) ) {
        result[0] += (float)0.9498375784745511;
        result[1] += (float)0.05016242152544896;
      } else {
        result[0] += (float)0.5079225957242043;
        result[1] += (float)0.4920774042757957;
      }
    }
  } else {
    result[0] += (float)0;
  ...
  if ( LIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)0.2024775072932243347) ) ) {
    if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
      ...
      if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2436483129858970642) ) ) {
        result[0] += (float)0.6281368821292775;
        result[1] += (float)0.37186311787072246;
      } else {
        result[0] += (float)0.9873717561858781;
        result[1] += (float)0.012628243814121908;
      }
    }
  } else {
    if ( UNLIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.04389595240354537964) ) ) {
      if ( LIKELY( !(data[31].missing != -1) || (data[31].fvalue <= (float)0.1599158719182014465) ) ) {
        result[0] += (float)1;
        result[1] += (float)0;
      } else {
        result[0] += (float)0;
      ...
      if ( UNLIKELY( !(data[18].missing != -1) || (data[18].fvalue <= (float)0.4180718958377838135) ) ) {
        result[0] += (float)0.11167002012072434;
        result[1] += (float)0.8883299798792756;
      } else {
        result[0] += (float)0.0037400654511453952;
        result[1] += (float)0.9962599345488546;
      }
    }
  }
  if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7603332698345184326) ) ) {
    ...
    if ( LIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8154961466789245605) ) ) {
      if ( UNLIKELY( !(data[37].missing != -1) || (data[37].fvalue <= (float)0.7164503633975982666) ) ) {
        ...
        result[0] += (float)0.9928757602085143;
        result[1] += (float)0.007124239791485664;
      }
    } else {
      if ( UNLIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.04389595240354537964) ) ) {
        result[0] += (float)0.964826520578733;
        result[1] += (float)0.03517347942126703;
      } else {
        result[0] += (float)0.2969592820659697;
        result[1] += (float)0.7030407179340302;
      }
    }
  }
  if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
    ...
    if ( UNLIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8081411123275756836) ) ) {
      ...
      if ( LIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.3460290580987930298) ) ) {
        result[0] += (float)0.9648121664515679;
        result[1] += (float)0.03518783354843211;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
  ...
  if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.7658493518829345703) ) ) {
    ...
    if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.351395338773727417) ) ) {
      ...
      if ( UNLIKELY( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.2511906176805496216) ) ) {
        result[0] += (float)0.6016411471110735;
        result[1] += (float)0.3983588528889265;
      } else {
        result[0] += (float)0.9886332944925881;
        result[1] += (float)0.011366705507411895;
      }
    }
  }
  if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
    ...
    if ( UNLIKELY( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.001762012368999421597) ) ) {
      ...
      if ( LIKELY( !(data[45].missing != -1) || (data[45].fvalue <= (float)0.745397716760635376) ) ) {
        result[0] += (float)0.9512021453671167;
        result[1] += (float)0.048797854632883296;
      } else {
        result[0] += (float)0.989262527051773;
        result[1] += (float)0.010737472948227068;
      }
    }
  }
  if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.351395338773727417) ) ) {
    if ( UNLIKELY( !(data[53].missing != -1) || (data[53].fvalue <= (float)0.7156386375427246094) ) ) {
      ...
      if ( UNLIKELY( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.8182544112205505371) ) ) {
        result[0] += (float)0.270836988945429;
        result[1] += (float)0.7291630110545709;
      } else {
        result[0] += (float)0.004317854707976668;
        result[1] += (float)0.9956821452920234;
      }
    }
  } else {
    if ( UNLIKELY( !(data[46].missing != -1) || (data[46].fvalue <= (float)0.7655960023403167725) ) ) {
      ...
      if ( UNLIKELY( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.2511906176805496216) ) ) {
        result[0] += (float)0.6158289507716183;
        result[1] += (float)0.38417104922838174;
      } else {
        result[0] += (float)0.9887423559206869;
        result[1] += (float)0.011257644079313114;
      }
    }
  }
