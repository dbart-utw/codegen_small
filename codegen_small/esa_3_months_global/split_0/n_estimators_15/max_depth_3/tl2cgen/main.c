...
void predict(union Entry* data, int pred_margin, float* result) {
  ...
  if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1359096989035606384) ) ) {
    ...
    if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2692928612232208252) ) ) {
      if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7676883339881896973) ) ) {
        result[0] += (float)0.837124339135475;
        result[1] += (float)0.16287566086452496;
      } else {
        result[0] += (float)0.10574065384013764;
        result[1] += (float)0.8942593461598624;
      }
    } else {
      if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.351395338773727417) ) ) {
        ...
        result[0] += (float)0.9991282804184254;
        result[1] += (float)0.0008717195815746008;
      }
    }
  }
  if ( LIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.1015841327607631683) ) ) {
    if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2692928612232208252) ) ) {
      if ( LIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.4158186167478561401) ) ) {
        result[0] += (float)0.8723022504741887;
        result[1] += (float)0.12769774952581125;
      } else {
        result[0] += (float)0.0012653987867058691;
        result[1] += (float)0.9987346012132942;
      }
    } else {
      if ( UNLIKELY( !(data[42].missing != -1) || (data[42].fvalue <= (float)0.001670926285441964865) ) ) {
        ...
        result[0] += (float)0.9951674263975049;
        result[1] += (float)0.004832573602495116;
      }
    }
  } else {
    result[0] += (float)0;
  ...
  if ( LIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.1015841327607631683) ) ) {
    if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
      ...
      if ( UNLIKELY( !(data[37].missing != -1) || (data[37].fvalue <= (float)0.720558464527130127) ) ) {
        ...
        result[0] += (float)0.9652521804816294;
        result[1] += (float)0.0347478195183706;
      }
    }
  } else {
    result[0] += (float)0;
  ...
  if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.7658493518829345703) ) ) {
    ...
    if ( LIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.3460290580987930298) ) ) {
      if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2692928612232208252) ) ) {
        result[0] += (float)0.6174089558009714;
        result[1] += (float)0.38259104419902856;
      } else {
        result[0] += (float)0.9947918451259209;
        result[1] += (float)0.005208154874079151;
      }
    } else {
      result[0] += (float)0;
      result[1] += (float)1;
  ...
  if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
    ...
    if ( UNLIKELY( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.001762012368999421597) ) ) {
      if ( UNLIKELY( !(data[12].missing != -1) || (data[12].fvalue <= (float)0.3772213906049728394) ) ) {
        result[0] += (float)0.26557377049180325;
        result[1] += (float)0.7344262295081967;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
      ...
      if ( LIKELY( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.001772137475199997425) ) ) {
        result[0] += (float)0.9504571412755671;
        result[1] += (float)0.04954285872443284;
      } else {
        result[0] += (float)0.9901078384930476;
        result[1] += (float)0.009892161506952378;
      }
    }
  }
  if ( UNLIKELY( !(data[46].missing != -1) || (data[46].fvalue <= (float)0.7666589617729187012) ) ) {
    if ( UNLIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.09636001661419868469) ) ) {
      ...
      if ( LIKELY( !(data[47].missing != -1) || (data[47].fvalue <= (float)0.7464606761932373047) ) ) {
        ...
        result[0] += (float)0.002707581227436823;
        result[1] += (float)0.9972924187725631;
      }
    }
  } else {
    if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3528395742177963257) ) ) {
      ...
      if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
        ...
        result[0] += (float)0.9688270366336066;
        result[1] += (float)0.031172963366393396;
      }
    }
  }
  if ( UNLIKELY( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.8118190765380859375) ) ) {
    ...
    if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.2768351733684539795) ) ) {
      if ( LIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.3528395742177963257) ) ) {
        result[0] += (float)3.989467804994814e-05;
        result[1] += (float)0.99996010532195;
      } else {
        result[0] += (float)0.8765058521267485;
        result[1] += (float)0.1234941478732515;
      }
    } else {
      if ( UNLIKELY( !(data[37].missing != -1) || (data[37].fvalue <= (float)0.7196456193923950195) ) ) {
        ...
        result[0] += (float)0.9566304736163537;
        result[1] += (float)0.043369526383646335;
      }
    }
  }
  if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3528395742177963257) ) ) {
    if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1397762447595596313) ) ) {
      if ( UNLIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.03405280830338597298) ) ) {
        result[0] += (float)1;
        result[1] += (float)0;
      } else {
        result[0] += (float)0;
      ...
      if ( UNLIKELY( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.8182544112205505371) ) ) {
        result[0] += (float)0.1809787626962142;
        result[1] += (float)0.8190212373037857;
      } else {
        result[0] += (float)0.00027396188016124616;
        result[1] += (float)0.9997260381198387;
      }
    }
  } else {
    if ( UNLIKELY( !(data[47].missing != -1) || (data[47].fvalue <= (float)0.7464606761932373047) ) ) {
      ...
      if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.24515543133020401) ) ) {
        result[0] += (float)0.6263302160593357;
        result[1] += (float)0.3736697839406643;
      } else {
        result[0] += (float)0.9890063130531658;
        result[1] += (float)0.01099368694683419;
      }
    }
  }
  if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.7658493518829345703) ) ) {
    ...
    if ( UNLIKELY( !(data[58].missing != -1) || (data[58].fvalue <= (float)0.3217779546976089478) ) ) {
      if ( LIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.4158186167478561401) ) ) {
        result[0] += (float)0.8982110881243373;
        result[1] += (float)0.1017889118756628;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
      ...
      if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
        ...
        result[0] += (float)0.9991346187130049;
        result[1] += (float)0.00086538128699505;
      }
    }
  }
  if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7603332698345184326) ) ) {
    if ( UNLIKELY( !(data[28].missing != -1) || (data[28].fvalue <= (float)0.2326309755444526672) ) ) {
      ...
      if ( UNLIKELY( !(data[30].missing != -1) || (data[30].fvalue <= (float)0.3093754053115844727) ) ) {
        ...
        result[0] += (float)0.00045835515976951286;
        result[1] += (float)0.9995416448402304;
      }
    }
  } else {
    if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.2768351733684539795) ) ) {
      if ( LIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3542838096618652344) ) ) {
        ...
        result[0] += (float)0.8739135279696902;
        result[1] += (float)0.1260864720303098;
      }
    } else {
      if ( LIKELY( !(data[62].missing != -1) || (data[62].fvalue <= (float)0.9933518767356872559) ) ) {
        result[0] += (float)0.9736370413844518;
        result[1] += (float)0.026362958615548118;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
  ...
  if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3557280451059341431) ) ) {
    ...
    if ( LIKELY( !(data[12].missing != -1) || (data[12].fvalue <= (float)0.3834608942270278931) ) ) {
      if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2436483129858970642) ) ) {
        result[0] += (float)0.6292153589315526;
        result[1] += (float)0.3707846410684474;
      } else {
        result[0] += (float)0.9875387055358357;
        result[1] += (float)0.012461294464164338;
      }
    } else {
      result[0] += (float)0;
      result[1] += (float)1;
  ...
  if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.389156639575958252) ) ) {
    ...
    if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.4284365326166152954) ) ) {
      if ( LIKELY( !(data[12].missing != -1) || (data[12].fvalue <= (float)0.3819010108709335327) ) ) {
        result[0] += (float)0.6604557587870978;
        result[1] += (float)0.3395442412129022;
      } else {
        result[0] += (float)0.1600403180647329;
        result[1] += (float)0.8399596819352672;
      }
    } else {
      if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2692928612232208252) ) ) {
        result[0] += (float)0.03070175438596491;
        result[1] += (float)0.9692982456140351;
      } else {
        result[0] += (float)0.998697256167858;
        result[1] += (float)0.0013027438321420338;
      }
    }
  }
  if ( UNLIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.7750433683395385742) ) ) {
    ...
    if ( LIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)0.2024775072932243347) ) ) {
      if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.351395338773727417) ) ) {
        result[0] += (float)0.11409748747240425;
        result[1] += (float)0.8859025125275958;
      } else {
        result[0] += (float)0.9664233367480711;
        result[1] += (float)0.03357666325192885;
      }
    } else {
      if ( UNLIKELY( !(data[62].missing != -1) || (data[62].fvalue <= (float)0.993042677640914917) ) ) {
        result[0] += (float)0.3527397260273973;
        result[1] += (float)0.6472602739726028;
      } else {
        result[0] += (float)0.034922133081642284;
        result[1] += (float)0.9650778669183577;
      }
    }
  }
  if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.389156639575958252) ) ) {
    ...
    if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7676883339881896973) ) ) {
      if ( LIKELY( !(data[29].missing != -1) || (data[29].fvalue <= (float)0.3132751137018203735) ) ) {
        result[0] += (float)0.9807930327313464;
        result[1] += (float)0.019206967268653615;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
      ...
      if ( LIKELY( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.2738175839185714722) ) ) {
        result[0] += (float)0.10651778432971583;
        result[1] += (float)0.8934822156702842;
      } else {
        result[0] += (float)0.9793402323756865;
        result[1] += (float)0.02065976762431352;
      }
    }
  }
  if ( LIKELY( !(data[23].missing != -1) || (data[23].fvalue <= (float)0.1516199931502342224) ) ) {
    if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3571722805500030518) ) ) {
      ...
      if ( UNLIKELY( !(data[47].missing != -1) || (data[47].fvalue <= (float)0.745397716760635376) ) ) {
        ...
        result[0] += (float)0.9579553743430528;
        result[1] += (float)0.042044625656947276;
      }
    }
  } else {
    if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.287395089864730835) ) ) {
      if ( UNLIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8173351287841796875) ) ) {
        result[0] += (float)0.5588442565186751;
        result[1] += (float)0.44115574348132486;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
      ...
      if ( UNLIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7584942877292633057) ) ) {
        ...
        result[0] += (float)0.9982376926443824;
        result[1] += (float)0.0017623073556174986;
      }
    }
  }
