  ...
  if ( UNLIKELY( !(data[62].missing != -1) || (data[62].fvalue <= (float)0.9927334785461425781) ) ) {
    ...
    if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1359096989035606384) ) ) {
      ...
      if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3528395742177963257) ) ) {
        result[0] += (float)0.0982687881517062;
        result[1] += (float)0.9017312118482939;
      } else {
        result[0] += (float)0.9522369543304644;
        result[1] += (float)0.04776304566953555;
      }
    }
  }
  if ( UNLIKELY( !(data[62].missing != -1) || (data[62].fvalue <= (float)0.9927334785461425781) ) ) {
    ...
    if ( LIKELY( !(data[58].missing != -1) || (data[58].fvalue <= (float)0.3217779546976089478) ) ) {
      if ( LIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.7823984324932098389) ) ) {
        result[0] += (float)0.7063848360144657;
        result[1] += (float)0.29361516398553433;
      } else {
        result[0] += (float)0.1778875849289685;
        result[1] += (float)0.8221124150710315;
      }
    } else {
      if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.287395089864730835) ) ) {
        ...
        result[0] += (float)0.9995610082946328;
        result[1] += (float)0.0004389917053672512;
      }
    }
  }
  if ( UNLIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8081411123275756836) ) ) {
    ...
    if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.2768351733684539795) ) ) {
      if ( LIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.3528395742177963257) ) ) {
        result[0] += (float)4.018808021540811e-05;
        result[1] += (float)0.9999598119197846;
      } else {
        result[0] += (float)0.8810073806975041;
        result[1] += (float)0.11899261930249591;
      }
    } else {
      if ( UNLIKELY( !(data[40].missing != -1) || (data[40].fvalue <= (float)0.6774668097496032715) ) ) {
        ...
        result[0] += (float)0.9562430475064372;
        result[1] += (float)0.043756952493562866;
      }
    }
  }
  if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.1294692680239677429) ) ) {
    ...
    if ( LIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.7732043862342834473) ) ) {
      if ( UNLIKELY( !(data[52].missing != -1) || (data[52].fvalue <= (float)0.7815771698951721191) ) ) {
        result[0] += (float)0.01833827056002257;
        result[1] += (float)0.9816617294399774;
      } else {
        result[0] += (float)0.9791897187059051;
        result[1] += (float)0.020810281294094957;
      }
    } else {
      if ( LIKELY( !(data[41].missing != -1) || (data[41].fvalue <= (float)0.001774667529389262199) ) ) {
        result[0] += (float)0.35990220048899757;
        result[1] += (float)0.6400977995110024;
      } else {
        result[0] += (float)0.8313953488372093;
        result[1] += (float)0.1686046511627907;
      }
    }
  }
  if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.389156639575958252) ) ) {
    ...
    if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.351395338773727417) ) ) {
      ...
      if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.3234125673770904541) ) ) {
        result[0] += (float)0.9656292480503684;
        result[1] += (float)0.03437075194963154;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
  ...
  if ( UNLIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8081411123275756836) ) ) {
    ...
    if ( LIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.7732043862342834473) ) ) {
      if ( UNLIKELY( !(data[37].missing != -1) || (data[37].fvalue <= (float)0.6840395033359527588) ) ) {
        ...
        result[0] += (float)0.9743048044557208;
        result[1] += (float)0.02569519554427923;
      }
    } else {
      if ( LIKELY( !(data[46].missing != -1) || (data[46].fvalue <= (float)0.770910799503326416) ) ) {
        result[0] += (float)0.3627674221563228;
        result[1] += (float)0.6372325778436772;
      } else {
        result[0] += (float)0.8090759599573032;
        result[1] += (float)0.19092404004269684;
      }
    }
  }
  if ( UNLIKELY( !(data[7].missing != -1) || (data[7].fvalue <= (float)0.7658493518829345703) ) ) {
    ...
    if ( UNLIKELY( !(data[46].missing != -1) || (data[46].fvalue <= (float)0.7597486972808837891) ) ) {
      ...
      if ( LIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1423501297831535339) ) ) {
        result[0] += (float)0.9074735420931144;
        result[1] += (float)0.09252645790688559;
      } else {
        result[0] += (float)0.40410303871664355;
        result[1] += (float)0.5958969612833565;
      }
    }
  }
  if ( UNLIKELY( !(data[58].missing != -1) || (data[58].fvalue <= (float)0.2304814010858535767) ) ) {
    ...
    if ( LIKELY( !(data[12].missing != -1) || (data[12].fvalue <= (float)0.3819010108709335327) ) ) {
      if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.351395338773727417) ) ) {
        ...
        result[0] += (float)0.9510242359346897;
        result[1] += (float)0.04897576406531035;
      }
    } else {
      if ( UNLIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.04389595240354537964) ) ) {
        result[0] += (float)0.869215291750503;
        result[1] += (float)0.13078470824949698;
      } else {
        result[0] += (float)0.15616469517743403;
        result[1] += (float)0.843835304822566;
      }
    }
  }
  if ( UNLIKELY( !(data[54].missing != -1) || (data[54].fvalue <= (float)0.8832333683967590332) ) ) {
    ...
    if ( UNLIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.04389595240354537964) ) ) {
      if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)0.1539440527558326721) ) ) {
        result[0] += (float)0.9993877928198494;
        result[1] += (float)0.0006122071801506261;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
      ...
      if ( LIKELY( !(data[10].missing != -1) || (data[10].fvalue <= (float)0.3241925090551376343) ) ) {
        result[0] += (float)0.5471828735754607;
        result[1] += (float)0.45281712642453936;
      } else {
        result[0] += (float)0;
        result[1] += (float)1;
      }
  ...
  if ( UNLIKELY( !(data[25].missing != -1) || (data[25].fvalue <= (float)0.7750433683395385742) ) ) {
    ...
    if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.3210727423429489136) ) ) {
      if ( LIKELY( !(data[16].missing != -1) || (data[16].fvalue <= (float)0.7676883339881896973) ) ) {
        result[0] += (float)0.9753393788503826;
        result[1] += (float)0.02466062114961746;
      } else {
        result[0] += (float)0.5216431637032496;
        result[1] += (float)0.47835683629675047;
      }
    } else {
      if ( LIKELY( !(data[9].missing != -1) || (data[9].fvalue <= (float)0.3622884899377822876) ) ) {
        result[0] += (float)0.4228163992869875;
        result[1] += (float)0.5771836007130124;
      } else {
        result[0] += (float)0.015473887814313346;
        result[1] += (float)0.9845261121856866;
      }
    }
  }
