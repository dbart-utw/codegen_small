      ...
      if ( LIKELY( !(data[27].missing != -1) || (data[27].fvalue <= (float)0.2039853483438491821) ) ) {
        if ( UNLIKELY( !(data[46].missing != -1) || (data[46].fvalue <= (float)0.71616324782371521) ) ) {
          ...
          if ( UNLIKELY( !(data[21].missing != -1) || (data[21].fvalue <= (float)0.2511906176805496216) ) ) {
            ...
            result[0] += (float)0.9952183092481369;
            result[1] += (float)0.0047816907518630275;
          }
        }
      } else {
        result[0] += (float)0;
      ...
      if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.3528395742177963257) ) ) {
        if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2813598960638046265) ) ) {
          if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1397762447595596313) ) ) {
            ...
            result[1] += (float)0.987012987012987;
          } else {
            result[0] += (float)0;
            result[1] += (float)1;
          }
        ...
        if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)0.2511906176805496216) ) ) {
          if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3571722805500030518) ) ) {
            ...
            result[0] += (float)0.8517140058765916;
            result[1] += (float)0.14828599412340843;
          }
        } else {
          if ( UNLIKELY( !(data[39].missing != -1) || (data[39].fvalue <= (float)0.7485989928245544434) ) ) {
            ...
            result[0] += (float)0.9977395411605938;
            result[1] += (float)0.0022604588394062076;
          }
        }
      }
    }
      ...
      if ( UNLIKELY( !(data[32].missing != -1) || (data[32].fvalue <= (float)0.3571722805500030518) ) ) {
        ...
        if ( UNLIKELY( !(data[35].missing != -1) || (data[35].fvalue <= (float)0.7537131011486053467) ) ) {
          ...
          if ( LIKELY( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.8191741108894348145) ) ) {
            result[0] += (float)0.9990378602010872;
            result[1] += (float)0.000962139798912782;
          } else {
            result[0] += (float)0.9636859781696053;
            result[1] += (float)0.03631402183039462;
          }
        }
      }
    }
      ...
      if ( UNLIKELY( !(data[43].missing != -1) || (data[43].fvalue <= (float)0.001774667529389262199) ) ) {
        ...
        if ( UNLIKELY( !(data[24].missing != -1) || (data[24].fvalue <= (float)0.3528395742177963257) ) ) {
          if ( UNLIKELY( !(data[17].missing != -1) || (data[17].fvalue <= (float)0.2989675849676132202) ) ) {
            result[0] += (float)0.0025;
            result[1] += (float)0.9975;
          } else {
            result[0] += (float)0;
            result[1] += (float)1;
          }
          ...
          if ( UNLIKELY( !(data[15].missing != -1) || (data[15].fvalue <= (float)0.1365531682968139648) ) ) {
            ...
            result[0] += (float)0.9745027752081407;
            result[1] += (float)0.02549722479185939;
          }
        }
      }
    }
      ...
      if ( UNLIKELY( !(data[43].missing != -1) || (data[43].fvalue <= (float)0.001774667529389262199) ) ) {
        ...
        if ( UNLIKELY( !(data[34].missing != -1) || (data[34].fvalue <= (float)0.8118190765380859375) ) ) {
          ...
          if ( LIKELY( !(data[57].missing != -1) || (data[57].fvalue <= (float)0.04389595240354537964) ) ) {
            result[0] += (float)0.9997694311867377;
            result[1] += (float)0.00023056881326231814;
          } else {
            result[0] += (float)0.9088489687292083;
            result[1] += (float)0.09115103127079174;
          }
        }
      }
    }
      ...
      if ( UNLIKELY( !(data[26].missing != -1) || (data[26].fvalue <= (float)0.8081411123275756836) ) ) {
        ...
        if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.4268460869789123535) ) ) {
          if ( UNLIKELY( !(data[14].missing != -1) || (data[14].fvalue <= (float)0.3542838096618652344) ) ) {
            ...
            result[0] += (float)0.9648867495055785;
            result[1] += (float)0.03511325049442143;
          }
        } else {
          if ( UNLIKELY( !(data[59].missing != -1) || (data[59].fvalue <= (float)0.4316533952951431274) ) ) {
            result[0] += (float)0.9887370753323486;
            result[1] += (float)0.011262924667651403;
          } else {
            result[0] += (float)1;
            result[1] += (float)0;
          }
      ...
      if ( UNLIKELY( !(data[47].missing != -1) || (data[47].fvalue <= (float)0.745397716760635376) ) ) {
        ...
        if ( LIKELY( !(data[43].missing != -1) || (data[43].fvalue <= (float)0.001787317683920264244) ) ) {
          if ( UNLIKELY( !(data[13].missing != -1) || (data[13].fvalue <= (float)0.2511906176805496216) ) ) {
            result[0] += (float)0.6009901820928086;
            result[1] += (float)0.3990098179071914;
          } else {
            result[0] += (float)0.9965656350672846;
            result[1] += (float)0.00343436493271547;
          }
        } else {
          if ( LIKELY( !(data[66].missing != -1) || (data[66].fvalue <= (float)3.177672624588012695e-06) ) ) {
            result[0] += (float)0.9990764749760239;
            result[1] += (float)0.0009235250239761305;
          } else {
            result[0] += (float)0;
            result[1] += (float)1;
          }
