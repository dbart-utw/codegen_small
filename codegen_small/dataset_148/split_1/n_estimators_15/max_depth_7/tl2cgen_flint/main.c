...
void predict(union Entry* data, int pred_margin, float* result) {
          ...
          if ( UNLIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ) ^ (0b1 << 31))>((int)(0x43ae0000))) ) ) {
            ...
            if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42440000))) ) ) {
              ...
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41dc0000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0.0005491488193300386;
                result[2] += (float)0.0010982976386600771;
                result[3] += (float)0.9967051070840198;
                result[4] += (float)0.0016474464579901156;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
          ...
          if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x41580000))) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41100000))) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42140000))) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.11290322580645161;
                result[3] += (float)0.7043010752688172;
                result[4] += (float)0.1827956989247312;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            } else {
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429f0000))) ) ) {
                result[0] += (float)0.5023419203747073;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.49765807962529274;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41d00000))) ) ) {
              if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3f000000))) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0019230769230769232;
              } else {
                result[0] += (float)1;
                result[1] += (float)0;
                result[2] += (float)0;
            ...
            if ( UNLIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ) ^ (0b1 << 31))>((int)(0x3fc00000))) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429f0000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.6577181208053692;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.8533333333333334;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.14666666666666667;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
                result[0] += (float)0.6701183431952663;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.3269230769230769;
                result[4] += (float)0.0014792899408284023;
                result[5] += (float)0;
                result[6] += (float)0.0014792899408284023;
              } else {
                result[0] += (float)0.7471783295711062;
                result[1] += (float)0;
                result[2] += (float)0.0022573363431151244;
                result[3] += (float)0.24830699774266368;
                result[4] += (float)0;
          ...
          if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3f000000))) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41bc0000))) ) ) {
              ...
              if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41e80000))) ) ) {
                ...
                result[1] += (float)0.03258145363408522;
                result[2] += (float)0;
                result[3] += (float)0.015037593984962407;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9987145703451379;
                result[1] += (float)0.0002570859309724275;
                result[2] += (float)0.0003213574137155344;
                result[3] += (float)0.0007069863101741757;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            ...
            if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41e80000))) ) ) {
              ...
              if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429d0000))) ) ) {
                result[0] += (float)0.9939178915357324;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.006082108464267613;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9998315931289997;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.0001684068710003368;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42df0000))) ) ) {
            if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40e00000))) ) ) {
                result[0] += (float)0.9571917808219178;
                result[1] += (float)0;
                result[2] += (float)0.032534246575342464;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.010273972602739725;
              } else {
                result[0] += (float)1;
                result[1] += (float)0;
                result[2] += (float)0;
              ...
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40e00000))) ) ) {
                result[0] += (float)0.9964881474978051;
                result[1] += (float)0;
          ...
          if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42140000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x3f800000))) ) ) {
              ...
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422e0000))) ) ) {
                result[0] += (float)0.979328165374677;
                result[1] += (float)0;
                result[2] += (float)0.01808785529715762;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.002583979328165375;
              } else {
                result[0] += (float)1;
                result[1] += (float)0;
                result[2] += (float)0;
            ...
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x3f800000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x420e0000))) ) ) {
                ...
                result[0] += (float)0.9995898277276456;
                result[1] += (float)0;
                result[2] += (float)0.00041017227235438887;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42340000))) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41300000))) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x429b0000))) ) ) {
                result[0] += (float)0.9965986394557823;
                result[1] += (float)0;
                result[2] += (float)0.003401360544217687;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9790419161676647;
                result[1] += (float)0;
                result[2] += (float)0.020958083832335328;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41d00000))) ) ) {
                result[0] += (float)0.9679351656095843;
                result[1] += (float)0.0035236081747709656;
                result[2] += (float)0.005990133897110641;
                result[3] += (float)0.02149400986610289;
                result[4] += (float)0;
                result[5] += (float)0;
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a00000))) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429b0000))) ) ) {
                ...
                result[2] += (float)0.04090909090909091;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42a30000))) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.01006036217303823;
                result[3] += (float)0.9899396378269618;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42100000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x422c0000))) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42180000))) ) ) {
                result[0] += (float)0.9929797191887676;
                result[1] += (float)0;
                result[2] += (float)0.0062402496099844;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.00078003120124805;
              } else {
                result[0] += (float)0.93125;
                result[1] += (float)0;
                result[2] += (float)0.06875;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
      ...
      if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40400000))) ) ) {
        if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3fc00000))) ) ) {
          if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x3f800000))) ) ) {
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421a0000))) ) ) {
                result[0] += (float)0.9944521497919556;
                result[1] += (float)0;
                result[2] += (float)0.005547850208044383;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9575757575757575;
                result[1] += (float)0;
              ...
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422a0000))) ) ) {
                result[0] += (float)0.9993101545253863;
                result[1] += (float)0;
                result[2] += (float)0.0006898454746136866;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9978849407783418;
                result[1] += (float)0;
                result[2] += (float)0.0021150592216582064;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
        ...
        if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422a0000))) ) ) {
          if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x41380000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41700000))) ) ) {
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40e00000))) ) ) {
                result[0] += (float)0.35231586940015186;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.6476841305998481;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.42915904936014626;
                result[1] += (float)0.0009140767824497258;
                result[2] += (float)0.004570383912248629;
                result[3] += (float)0.5653564899451554;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            } else {
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41c00000))) ) ) {
                result[0] += (float)0.9851088201603666;
                result[1] += (float)0;
                result[2] += (float)0.010309278350515464;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.004581901489117984;
              } else {
                result[0] += (float)0;
                result[1] += (float)0.029661016949152543;
                result[2] += (float)0.02754237288135593;
                result[3] += (float)0.9427966101694916;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            ...
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41500000))) ) ) {
              if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x421c0000))) ) ) {
                result[0] += (float)0.9940652818991098;
                result[1] += (float)0;
                result[2] += (float)0.005934718100890208;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422e0000))) ) ) {
            ...
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42910000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.2153846153846154;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.07692307692307693;
              } else {
                result[0] += (float)0.9755351681957186;
                result[1] += (float)0;
                result[2] += (float)0.024464831804281346;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41700000))) ) ) {
            ...
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41d40000))) ) ) {
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41f00000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.0025334781035106766;
                result[3] += (float)0.9974665218964893;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42140000))) ) ) {
              ...
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.007782101167315175;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a30000))) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42360000))) ) ) {
                result[0] += (float)0.9991460290350128;
                result[1] += (float)0;
                result[2] += (float)0.0008539709649871904;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x40c00000))) ) ) {
            ...
            if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3f000000))) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42120000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0.014606741573033709;
                result[2] += (float)0.03258426966292135;
                result[3] += (float)0.9471910112359551;
                result[4] += (float)0;
                result[5] += (float)0.0056179775280898875;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.5324390243902439;
                result[1] += (float)0;
                result[2] += (float)0.003902439024390244;
                result[3] += (float)0.4626829268292683;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.000975609756097561;
              }
            } else {
              if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42120000))) ) ) {
                result[0] += (float)0.004434589800443459;
                result[1] += (float)0;
                ...
                result[0] += (float)0.6045907319185795;
                result[1] += (float)0;
                result[2] += (float)0.0008661758336942399;
                result[3] += (float)0.39454309224772627;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42100000))) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42180000))) ) ) {
                ...
                result[0] += (float)0.9606741573033708;
                result[1] += (float)0;
              ...
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42940000))) ) ) {
                result[0] += (float)0.9267605633802817;
                result[1] += (float)0;
                result[2] += (float)0.056338028169014086;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.016901408450704224;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)1;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x40f00000))) ) ) {
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x418c0000))) ) ) {
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42640000))) ) ) {
                result[0] += (float)0.07792207792207792;
                result[1] += (float)0;
                result[2] += (float)0.09090909090909091;
                result[3] += (float)0.8311688311688312;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                ...
                result[3] += (float)0.997624703087886;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42a60000))) ) ) {
            if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x427c0000))) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421c0000))) ) ) {
                ...
                result[3] += (float)0.9884393063583815;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                ...
                result[1] += (float)0;
                result[2] += (float)0.06403940886699508;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a50000))) ) ) {
              ...
              if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ) ^ (0b1 << 31))>((int)(0x41d00000))) ) ) {
                ...
                result[4] += (float)0.6808510638297872;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
          ...
          if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x40600000))) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42160000))) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x420e0000))) ) ) {
                result[0] += (float)0.99800796812749;
                result[1] += (float)0;
                result[2] += (float)0.00199203187250996;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41940000))) ) ) {
            ...
            if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42600000))) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42c70000))) ) ) {
                result[0] += (float)0.0022194821208384712;
                result[1] += (float)0.0044389642416769425;
                result[2] += (float)0.0044389642416769425;
                result[3] += (float)0.9889025893958077;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41b00000))) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42220000))) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
                result[0] += (float)0.9967320261437909;
                result[1] += (float)0;
                result[2] += (float)0.0032679738562091504;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.009523809523809525;
              }
            } else {
              result[0] += (float)1;
              result[1] += (float)0;
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42970000))) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41300000))) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.005847953216374269;
              } else {
          ...
          if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x427a0000))) ) ) {
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421e0000))) ) ) {
              ...
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42d30000))) ) ) {
                result[0] += (float)0.9954395743602736;
                result[1] += (float)0;
                result[2] += (float)0.004560425639726374;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9457013574660634;
                result[1] += (float)0;
                result[2] += (float)0.04524886877828055;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
  ...
  if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40400000))) ) ) {
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x3f800000))) ) ) {
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42020000))) ) ) {
              ...
              if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
                ...
                result[0] += (float)0.9556962025316456;
                result[1] += (float)0;
                result[2] += (float)0.04430379746835443;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
    ...
    if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x420c0000))) ) ) {
      if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42af0000))) ) ) {
        if ( UNLIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ) ^ (0b1 << 31))>((int)(0x41a00000))) ) ) {
          if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42140000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41d80000))) ) ) {
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41d80000))) ) ) {
                result[0] += (float)0.9973467763332449;
                result[1] += (float)0;
                result[2] += (float)0.0021225789334040858;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0005306447333510214;
              } else {
                result[0] += (float)0.9390977443609023;
                result[1] += (float)0.005639097744360903;
                result[2] += (float)0.008646616541353385;
                result[3] += (float)0.044736842105263165;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0018796992481203009;
              }
            } else {
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
                result[0] += (float)0.5756302521008403;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.42436974789915966;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.7339246119733924;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.2660753880266075;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            ...
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421a0000))) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a80000))) ) ) {
                result[0] += (float)0.01079136690647482;
                result[1] += (float)0;
                result[2] += (float)0.013788968824940047;
                result[3] += (float)0.9748201438848921;
                result[4] += (float)0.0005995203836930455;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.03723404255319149;
                result[3] += (float)0.24468085106382978;
                result[4] += (float)0.7101063829787234;
                result[5] += (float)0.007978723404255319;
                result[6] += (float)0;
              }
            } else {
              if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421e0000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.019662921348314606;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42d60000))) ) ) {
            ...
            if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x43540000))) ) ) {
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42e60000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0.05063291139240506;
                result[2] += (float)0;
                result[3] += (float)0;
                result[4] += (float)0.9493670886075949;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                ...
                result[2] += (float)0;
                result[3] += (float)0;
                result[4] += (float)0.9984276729559748;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            } else {
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a50000))) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42b30000))) ) ) {
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x428a0000))) ) ) {
                ...
                result[3] += (float)0.22602739726027396;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42aa0000))) ) ) {
                result[0] += (float)0.02912621359223301;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.970873786407767;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.016566265060240965;
                result[4] += (float)0.983433734939759;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            }
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41f80000))) ) ) {
            if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x41b40000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x421e0000))) ) ) {
                ...
                result[2] += (float)0.023474178403755867;
                result[3] += (float)0.9624413145539906;
                result[4] += (float)0;
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42440000))) ) ) {
              ...
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a80000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9986876640419947;
                result[4] += (float)0;
                result[5] += (float)0.0013123359580052493;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
      ...
      if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422a0000))) ) ) {
        if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b70000))) ) ) {
          if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ) ^ (0b1 << 31))>((int)(0x41b80000))) ) ) {
            ...
            if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42af0000))) ) ) {
              if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41100000))) ) ) {
                result[0] += (float)0.9595092024539877;
                result[1] += (float)0;
                result[2] += (float)0.04049079754601227;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9980541141586361;
                result[1] += (float)0.0007876204595997036;
                result[2] += (float)0.0008339510748702744;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0003243143068939956;
              }
            } else {
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
                ...
                result[0] += (float)0.6218487394957983;
                result[1] += (float)0.08403361344537816;
                result[2] += (float)0;
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x422c0000))) ) ) {
            if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42af0000))) ) ) {
              if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a10000))) ) ) {
                ...
                result[0] += (float)0.9996413842567689;
                result[1] += (float)0;
                result[2] += (float)0.00035861574323112785;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42520000))) ) ) {
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x423c0000))) ) ) {
              ...
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
                ...
                result[0] += (float)0.9620462046204621;
                result[1] += (float)0;
                result[2] += (float)0.026402640264026403;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.01155115511551155;
              }
            }
          }
        }
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41a80000))) ) ) {
            ...
            if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
              ...
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3f000000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9912280701754386;
                result[4] += (float)0;
                result[5] += (float)0.008771929824561403;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
          ...
          if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b70000))) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42220000))) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x425a0000))) ) ) {
                result[0] += (float)0.9973172367538564;
                result[1] += (float)0;
                result[2] += (float)0.002012072434607646;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0006706908115358819;
              } else {
                result[0] += (float)0.9895287958115184;
                result[1] += (float)0;
              ...
              if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41300000))) ) ) {
                result[0] += (float)0.9990421455938697;
                result[1] += (float)0;
                result[2] += (float)0.0009578544061302681;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b90000))) ) ) {
              ...
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42000000))) ) ) {
                result[0] += (float)0.97002997002997;
                result[1] += (float)0;
                result[2] += (float)0.012487512487512488;
                result[3] += (float)0.013986013986013986;
                result[4] += (float)0;
                result[5] += (float)0;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x40d00000))) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x429b0000))) ) ) {
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x419c0000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9989909182643795;
                result[4] += (float)0;
                result[5] += (float)0.0010090817356205853;
                result[6] += (float)0;
              }
            } else {
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42b10000))) ) ) {
                result[0] += (float)0.3221586263286999;
                result[1] += (float)0;
                result[2] += (float)0.044153720359771054;
                result[3] += (float)0.633687653311529;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.12222222222222222;
                result[1] += (float)0.005555555555555556;
                result[2] += (float)0;
                result[3] += (float)0.8722222222222222;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41d80000))) ) ) {
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429b0000))) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.007692307692307693;
              }
            } else {
              result[0] += (float)1;
              result[1] += (float)0;
          ...
          if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x420c0000))) ) ) {
            if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40e00000))) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.2839506172839506;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.04938271604938271;
              }
            } else {
              result[0] += (float)1;
              result[1] += (float)0;
          ...
          if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x43ba8000))) ) ) {
            if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x424c0000))) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42220000))) ) ) {
                result[0] += (float)0.9986044151230652;
                result[1] += (float)0;
                result[2] += (float)0.001268713524486171;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0001268713524486171;
              } else {
                result[0] += (float)1;
                result[1] += (float)0;
                result[2] += (float)0;
              ...
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x422a0000))) ) ) {
                result[0] += (float)0.9962283127985919;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.0037716872014080965;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41500000))) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x420c0000))) ) ) {
              if ( LIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ))<=((int)(0x42830000))) ) ) {
                result[0] += (float)0.9941548952752071;
                result[1] += (float)0.000974184120798831;
                result[2] += (float)0.003896736483195324;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.000974184120798831;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)1;
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42260000))) ) ) {
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42480000))) ) ) {
                ...
                result[2] += (float)0;
                result[3] += (float)0.8452380952380952;
                result[4] += (float)0;
                result[5] += (float)0.023809523809523808;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.6721504112808461;
                result[1] += (float)0;
                result[2] += (float)0.01645123384253819;
                result[3] += (float)0.30669800235017625;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.004700352526439483;
              }
            } else {
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41700000))) ) ) {
                result[0] += (float)0.8733766233766234;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.1266233766233766;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9856759176365264;
                result[1] += (float)0;
                result[2] += (float)0.0017905102954341987;
                result[3] += (float)0.012533572068039392;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42890000))) ) ) {
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x423c0000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.00967741935483871;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.07926167209554831;
                result[1] += (float)0.004343105320304018;
                result[2] += (float)0.003800217155266015;
                result[3] += (float)0.9125950054288816;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b70000))) ) ) {
            ...
            if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42bb0000))) ) ) {
              ...
              if ( LIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ))<=((int)(0x3f000000))) ) ) {
                result[0] += (float)0.9318181818181819;
                result[1] += (float)0;
                result[2] += (float)0.02272727272727273;
          ...
          if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42a30000))) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42b30000))) ) ) {
              if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b70000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.3157894736842105;
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42440000))) ) ) {
            ...
            if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ) ^ (0b1 << 31))>((int)(0x42240000))) ) ) {
              ...
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0.004258943781942078;
                result[2] += (float)0.00596252129471891;
                result[3] += (float)0.989778534923339;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41100000))) ) ) {
            if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a70000))) ) ) {
              ...
              if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3f000000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.16279069767441862;
                result[3] += (float)0;
                result[4] += (float)0.8372093023255814;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41a40000))) ) ) {
              if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x41800000))) ) ) {
                result[0] += (float)0.2;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0;
          ...
          if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x429c0000))) ) ) {
            if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x425a0000))) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41900000))) ) ) {
                result[0] += (float)0.9987409122293976;
                result[1] += (float)0.00024369440721335446;
                result[2] += (float)0.0006904674871045042;
                result[3] += (float)0.00024369440721335446;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)8.123146907111815e-05;
              } else {
                result[0] += (float)0;
                result[1] += (float)1;
                result[2] += (float)0;
              ...
              if ( UNLIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ) ^ (0b1 << 31))>((int)(0x40900000))) ) ) {
                result[0] += (float)0.8589743589743589;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.14102564102564102;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9872340425531915;
                result[1] += (float)0;
                result[2] += (float)0.005106382978723404;
                result[3] += (float)0.006382978723404255;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.001276595744680851;
              }
            }
          } else {
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42a30000))) ) ) {
          ...
          if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42000000))) ) ) {
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42c10000))) ) ) {
              if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42bd0000))) ) ) {
                ...
                result[0] += (float)0.32653061224489793;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.673469387755102;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            } else {
              if ( LIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ))<=((int)(0x41c00000))) ) ) {
                result[0] += (float)0.9465648854961832;
                result[1] += (float)0;
                result[2] += (float)0.04198473282442748;
                result[3] += (float)0;
                result[4] += (float)0;
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41980000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41100000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42360000))) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.004626060138781804;
                result[3] += (float)0.9953739398612182;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
      ...
      if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ) ^ (0b1 << 31))>((int)(0x41000000))) ) ) {
        ...
        if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x429b0000))) ) ) {
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42970000))) ) ) {
            ...
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40e00000))) ) ) {
              if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
                result[0] += (float)0.9974721941354904;
                result[1] += (float)0;
                result[2] += (float)0.0025278058645096056;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9998028974081009;
                result[1] += (float)0;
                result[2] += (float)0.00019710259189908348;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x420c0000))) ) ) {
                result[0] += (float)0.9945607832472124;
                result[1] += (float)0.002991569214033179;
                result[2] += (float)0.0019037258634756595;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0005439216752787598;
              } else {
                result[0] += (float)0;
                result[1] += (float)0.75;
                result[2] += (float)0;
          ...
          if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42b50000))) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41600000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x427e0000))) ) ) {
                ...
                result[0] += (float)0.9228362877997914;
                result[1] += (float)0;
                result[2] += (float)0.022940563086548488;
                result[3] += (float)0.049009384775808136;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.005213764337851929;
              }
            }
          } else {
            result[0] += (float)0;
          ...
          if ( LIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ))<=((int)(0x42830000))) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42460000))) ) ) {
              ...
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.007772020725388601;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
        ...
        if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41700000))) ) ) {
          ...
          if ( UNLIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ) ^ (0b1 << 31))>((int)(0x40200000))) ) ) {
            ...
            if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
              ...
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a90000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0.0006353240152477764;
                result[2] += (float)0;
                result[3] += (float)0.9987293519695044;
                result[4] += (float)0;
                result[5] += (float)0.0006353240152477764;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
      ...
      if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x3f800000))) ) ) {
        ...
        if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42140000))) ) ) {
          if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
            ...
            if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a10000))) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422a0000))) ) ) {
                result[0] += (float)0.9828767123287672;
                result[1] += (float)0;
                result[2] += (float)0.0136986301369863;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.003424657534246575;
              } else {
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a30000))) ) ) {
            if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a10000))) ) ) {
              if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x40600000))) ) ) {
                ...
                result[0] += (float)0.9973166368515206;
                result[1] += (float)0;
                result[2] += (float)0.0026833631484794273;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42180000))) ) ) {
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42160000))) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42120000))) ) ) {
              ...
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41980000))) ) ) {
                ...
                result[0] += (float)0.16071428571428573;
                result[1] += (float)0;
                result[2] += (float)0.03571428571428571;
                result[3] += (float)0.8035714285714286;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            ...
            if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42000000))) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42140000))) ) ) {
                result[0] += (float)0.9965256797583082;
                result[1] += (float)0;
                result[2] += (float)0.001963746223564955;
                result[3] += (float)0.00030211480362537764;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0012084592145015106;
              } else {
                result[0] += (float)0.8719646799116998;
                result[1] += (float)0;
                result[2] += (float)0.03532008830022075;
                result[3] += (float)0.09271523178807947;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42760000))) ) ) {
                ...
                result[0] += (float)0.8644688644688645;
                result[1] += (float)0;
                result[2] += (float)0.040293040293040296;
        ...
        if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421e0000))) ) ) {
          if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x3f000000))) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x421e0000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42220000))) ) ) {
                result[0] += (float)0.8028169014084507;
                result[1] += (float)0;
                result[2] += (float)0.18309859154929578;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
          ...
          if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42340000))) ) ) {
            if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3f000000))) ) ) {
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x40600000))) ) ) {
                ...
                result[0] += (float)0.9938744257274119;
                result[1] += (float)0;
                result[2] += (float)0.006125574272588055;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a30000))) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41d80000))) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41700000))) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0.0012437810945273632;
                result[2] += (float)0.00041459369817578774;
                result[3] += (float)0.9975124378109452;
                result[4] += (float)0;
                result[5] += (float)0.0008291873963515755;
                result[6] += (float)0;
              }
            } else {
              if ( LIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ))<=((int)(0x3f000000))) ) ) {
                result[0] += (float)0.6447368421052632;
                result[1] += (float)0.21052631578947367;
                result[2] += (float)0.14473684210526316;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x40d00000))) ) ) {
              ...
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42440000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.09264305177111716;
                result[3] += (float)0.8991825613079019;
                result[4] += (float)0;
                result[5] += (float)0.008174386920980926;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
          ...
          if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422a0000))) ) ) {
            if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b60000))) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42240000))) ) ) {
                result[0] += (float)0.9935579781962339;
                result[1] += (float)0;
                result[2] += (float)0.004955401387512388;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0014866204162537165;
              } else {
            ...
            if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x40600000))) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.0017316017316017316;
                result[3] += (float)0.0025974025974025974;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.031746031746031744;
              }
            } else {
              if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422e0000))) ) ) {
                result[0] += (float)0.7412140575079872;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.25878594249201275;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9833770778652668;
                result[1] += (float)0;
                result[2] += (float)0.012248468941382326;
                result[3] += (float)0.004374453193350831;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41700000))) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x422a0000))) ) ) {
              if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42180000))) ) ) {
                result[0] += (float)0.995945945945946;
                result[1] += (float)0;
                result[2] += (float)0.0013513513513513514;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.002702702702702703;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0;
            ...
            if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42bd0000))) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x429b0000))) ) ) {
                ...
                result[0] += (float)0.9895104895104895;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.01048951048951049;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42c30000))) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421c0000))) ) ) {
              ...
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ) ^ (0b1 << 31))>((int)(0x3f800000))) ) ) {
                ...
                result[0] += (float)0.8765432098765432;
                result[1] += (float)0;
          ...
          if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42ca0000))) ) ) {
            if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42c90000))) ) ) {
              ...
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41e00000))) ) ) {
                result[0] += (float)0;
                result[1] += (float)0.0025380710659898475;
                result[2] += (float)0;
      ...
      if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a50000))) ) ) {
          ...
          if ( LIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ))<=((int)(0x40200000))) ) ) {
            if ( UNLIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ) ^ (0b1 << 31))>((int)(0x40600000))) ) ) {
              ...
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42f70000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9876160990712074;
                result[4] += (float)0.01238390092879257;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
        ...
        if ( UNLIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ) ^ (0b1 << 31))>((int)(0x41000000))) ) ) {
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a70000))) ) ) {
            if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42e10000))) ) ) {
              result[0] += (float)0;
              result[1] += (float)0;
              result[2] += (float)0;
              result[3] += (float)1;
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429b0000))) ) ) {
            ...
            if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x3f800000))) ) ) {
              ...
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42b30000))) ) ) {
                ...
                result[3] += (float)0.6785714285714286;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429f0000))) ) ) {
            if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42990000))) ) ) {
              ...
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41980000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9984544049459042;
                result[4] += (float)0;
                result[5] += (float)0.0015455950540958269;
                result[6] += (float)0;
              }
            }
          } else {
      ...
      if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421e0000))) ) ) {
        if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b70000))) ) ) {
          if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x41c40000))) ) ) {
            ...
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x41e00000))) ) ) {
              if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x429b0000))) ) ) {
                result[0] += (float)0.9936979060784713;
                result[1] += (float)0.0026428135799959345;
                result[2] += (float)0.003049400284610694;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0006098800569221388;
              } else {
                result[0] += (float)0.9992288578527976;
                result[1] += (float)0.00017136492160054837;
                result[2] += (float)0.00017136492160054837;
                result[3] += (float)0.00042841230400137093;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
        ...
        if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x40400000))) ) ) {
          ...
          if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x420c0000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x42140000))) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
                result[0] += (float)0.9931543865970096;
                result[1] += (float)0;
                result[2] += (float)0.0010808863267879663;
                result[3] += (float)0.005224283912808504;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0005404431633939832;
              } else {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.007462686567164179;
              }
            } else {
              result[0] += (float)0;
              result[1] += (float)0;
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a30000))) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || ((*( ((int*)(data)) + 6 ))<=((int)(0x3f800000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42120000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.001652892561983471;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42600000))) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42120000))) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42f90000))) ) ) {
                result[0] += (float)0.000536480686695279;
                result[1] += (float)0.0045600858369098714;
                result[2] += (float)0.008851931330472103;
                result[3] += (float)0.9841738197424893;
                result[4] += (float)0;
                result[5] += (float)0.0018776824034334764;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0.5263157894736842;
                result[2] += (float)0;
                result[3] += (float)0.47368421052631576;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42b40000))) ) ) {
                result[0] += (float)0.9595959595959597;
                result[1] += (float)0.030303030303030307;
                result[2] += (float)0.010101010101010104;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42a80000))) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x421a0000))) ) ) {
              if ( UNLIKELY( !(data[3].missing != -1) || ((*( ((int*)(data)) + 3 ) ^ (0b1 << 31))>((int)(0x41940000))) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.003067484662576687;
              }
            } else {
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x41b00000))) ) ) {
                result[0] += (float)0.9952481520591341;
                result[1] += (float)0;
            ...
            if ( LIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42a50000))) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || ((*( ((int*)(data)) + 5 ))<=((int)(0x42ac0000))) ) ) {
                ...
                result[3] += (float)0.9117647058823529;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( UNLIKELY( !(data[1].missing != -1) || ((*( ((int*)(data)) + 1 ) ^ (0b1 << 31))>((int)(0x42720000))) ) ) {
            ...
            if ( LIKELY( !(data[4].missing != -1) || ((*( ((int*)(data)) + 4 ))<=((int)(0x42890000))) ) ) {
              if ( LIKELY( !(data[2].missing != -1) || ((*( ((int*)(data)) + 2 ))<=((int)(0x42100000))) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.004630969609261939;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( LIKELY( !(data[0].missing != -1) || ((*( ((int*)(data)) + 0 ))<=((int)(0x42d50000))) ) ) {
                result[0] += (float)0.8803418803418803;
                result[1] += (float)0;
                result[2] += (float)0.08974358974358974;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.029914529914529916;
              } else {
