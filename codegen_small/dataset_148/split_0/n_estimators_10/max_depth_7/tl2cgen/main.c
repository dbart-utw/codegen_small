          ...
          if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)77.5) ) ) {
            if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)40.5) ) ) {
              ...
              if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)76.5) ) ) {
                ...
                result[0] += (float)0.9441860465116279;
                result[1] += (float)0;
                result[2] += (float)0;
          ...
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)102) ) ) {
            if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-20.5) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)42.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.15294117647058825;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)77) ) ) {
            if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)53) ) ) {
              if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)74.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.5945945945945946;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9978181818181818;
                result[4] += (float)0;
                result[5] += (float)0.002181818181818182;
                result[6] += (float)0;
              }
            } else {
              result[0] += (float)0;
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)15) ) ) {
            if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)71.5) ) ) {
              ...
              if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)29) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.09821428571428571;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.026785714285714284;
              }
            }
          } else {
            if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)40.5) ) ) {
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)17) ) ) {
                result[0] += (float)0.8909090909090909;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.10909090909090909;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.3701492537313433;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)21) ) ) {
                result[0] += (float)0.841743119266055;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.15825688073394495;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9969879518072289;
                result[1] += (float)0;
        ...
        if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)6.5) ) ) {
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
            ...
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)67) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)57) ) ) {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9961685823754789;
                result[4] += (float)0;
                result[5] += (float)0.0038314176245210726;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
          ...
          if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)42.5) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)24.5) ) ) {
              ...
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)35.5) ) ) {
                result[0] += (float)0.9990815857951937;
                result[1] += (float)0.00030613806826878924;
                result[2] += (float)0.0006122761365375785;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9948135688253434;
                result[1] += (float)0;
                result[2] += (float)0.000560695262125035;
                result[3] += (float)0.004345388281469021;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0002803476310625175;
              }
            }
          } else {
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)42.5) ) ) {
            if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)35) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)79.5) ) ) {
                result[0] += (float)0.9597087378640777;
                result[1] += (float)0.0043689320388349525;
                result[2] += (float)0.008252427184466022;
                result[3] += (float)0.026213592233009713;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0014563106796116507;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.010380622837370242;
              ...
              if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)59) ) ) {
                result[0] += (float)0.02308707124010554;
                result[1] += (float)0;
                result[2] += (float)0.0006596306068601583;
                result[3] += (float)0.9762532981530343;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
            ...
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
              if ( LIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)187) ) ) {
                result[0] += (float)0.9997488699146158;
                result[1] += (float)0;
                result[2] += (float)0.00025113008538422905;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)36) ) ) {
                result[0] += (float)0.999140154772141;
                result[1] += (float)0;
          ...
          if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)39) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)99) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)100.5) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0.057034220532319393;
                result[2] += (float)0;
                result[3] += (float)0.9429657794676806;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
  ...
  if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)25.5) ) ) {
    if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)28) ) ) {
      if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)5.5) ) ) {
        if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)221) ) ) {
          result[0] += (float)1;
          result[1] += (float)0;
          result[2] += (float)0;
          result[3] += (float)0;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)15) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)45.5) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)21.5) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.035856573705179286;
                result[3] += (float)0.9641434262948207;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)55) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9986440677966102;
                result[4] += (float)0;
                result[5] += (float)0.0013559322033898306;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.0033738191632928477;
                result[3] += (float)0.9966261808367072;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)81.5) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)42.5) ) ) {
              if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)43) ) ) {
                ...
                result[0] += (float)0.9950877192982456;
                result[1] += (float)0;
                result[2] += (float)0.004912280701754386;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)90.5) ) ) {
            if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)77.5) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)36.5) ) ) {
                ...
                result[0] += (float)0.9934839270199827;
                result[1] += (float)0;
                result[2] += (float)0.005212858384013901;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0013032145960034753;
              }
            } else {
              if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)1) ) ) {
                result[0] += (float)0.989406779661017;
                result[1] += (float)0;
                result[2] += (float)0.01059322033898305;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)63.5) ) ) {
              if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
                ...
                result[0] += (float)0.8255813953488372;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.1744186046511628;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)4) ) ) {
                ...
                result[0] += (float)0.952485701715794;
                result[1] += (float)0;
                result[2] += (float)0.007919049714034315;
                result[3] += (float)0.03783545974483062;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0017597888253409592;
              }
            }
          }
        } else {
          if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)39) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)27.5) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)81.5) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0.032490974729241874;
                result[2] += (float)0;
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)77.5) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)31.5) ) ) {
              ...
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)33.5) ) ) {
                ...
                result[0] += (float)0.9986301369863013;
                result[1] += (float)0;
                result[2] += (float)0.0013698630136986301;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)36.5) ) ) {
              ...
              if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
                ...
                result[0] += (float)0.9969834087481146;
                result[1] += (float)0;
        ...
        if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)75.5) ) ) {
          ...
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)99.5) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)18.5) ) ) {
              ...
              if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)100.5) ) ) {
                result[0] += (float)0.0010863661053775121;
                result[1] += (float)0.0032590983161325366;
                result[2] += (float)0.004073872895165671;
                result[3] += (float)0.9904942965779467;
                result[4] += (float)0;
                result[5] += (float)0.0010863661053775121;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0.038288288288288286;
                result[2] += (float)0;
                result[3] += (float)0.9617117117117117;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-3.5) ) ) {
            if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)91.5) ) ) {
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)49.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.0028089887640449437;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-5.5) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.015503875968992248;
            ...
            if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)51.5) ) ) {
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)11) ) ) {
                result[0] += (float)0.8153846153846154;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.18461538461538463;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.5661881977671451;
                result[1] += (float)0;
                result[2] += (float)0.001594896331738437;
                result[3] += (float)0.430622009569378;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.001594896331738437;
              }
            }
          }
        } else {
          if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-195.5) ) ) {
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)62.5) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)19) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.07471264367816093;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.5670103092783505;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.4329896907216495;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)37) ) ) {
                result[0] += (float)0.9889980353634578;
                result[1] += (float)0;
                result[2] += (float)0.007072691552062868;
                result[3] += (float)0.0011787819253438114;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.00275049115913556;
              } else {
                result[0] += (float)0.8329938900203666;
                result[1] += (float)0.002036659877800407;
                result[2] += (float)0.032586558044806514;
                result[3] += (float)0.13238289205702647;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)92.5) ) ) {
            if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-0.5) ) ) {
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)46.5) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.03571428571428571;
              } else {
                result[0] += (float)1;
                result[1] += (float)0;
                result[2] += (float)0;
          ...
          if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)35) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)73) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)68.5) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.03333333333333333;
              }
            } else {
              result[0] += (float)0;
              result[1] += (float)0;
        ...
        if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)81.5) ) ) {
          if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)48) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)95) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)15) ) ) {
                result[0] += (float)0.4444444444444445;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0;
                result[4] += (float)0.33333333333333337;
                result[5] += (float)0.22222222222222224;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.0009372071227741331;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9971883786316776;
                result[4] += (float)0;
          ...
          if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)91) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)7) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)36) ) ) {
                ...
                result[0] += (float)0.9924882629107982;
                result[1] += (float)0;
                result[2] += (float)0.007511737089201878;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              ...
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)38) ) ) {
                result[0] += (float)0.9981807155852032;
                result[1] += (float)0.0006822316555488174;
                result[2] += (float)0.0009096422073984233;
                result[3] += (float)0.00015160703456640388;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)7.580351728320194e-05;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)1;
      ...
      if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)43.5) ) ) {
        ...
        if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)68.5) ) ) {
          ...
          if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-8.5) ) ) {
            ...
            if ( LIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)25) ) ) {
              if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)29) ) ) {
                ...
                result[0] += (float)0.8358208955223881;
                result[1] += (float)0;
                result[2] += (float)0.13432835820895525;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.02985074626865672;
              }
            } else {
          ...
          if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)51.5) ) ) {
            ...
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)3) ) ) {
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)7) ) ) {
                result[0] += (float)0.985207100591716;
                result[1] += (float)0;
                result[2] += (float)0.011834319526627219;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0029585798816568047;
              } else {
                result[0] += (float)1;
                result[1] += (float)0;
                result[2] += (float)0;
          ...
          if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)53) ) ) {
            if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)90.5) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)34.5) ) ) {
                result[0] += (float)0.9960544217687075;
                result[1] += (float)0.0012244897959183673;
                ...
                result[0] += (float)0.9985988791032826;
                result[1] += (float)0;
                result[2] += (float)0.0010008006405124099;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.00040032025620496394;
              }
            } else {
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)38) ) ) {
                result[0] += (float)1;
            ...
            if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)94) ) ) {
              result[0] += (float)0;
              result[1] += (float)0;
              result[2] += (float)0;
              result[3] += (float)1;
              ...
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)80) ) ) {
                result[0] += (float)0.9337748344370861;
                result[1] += (float)0.06622516556291391;
                result[2] += (float)0;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
          ...
          if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
            if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)48.5) ) ) {
              ...
              if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)68.5) ) ) {
                ...
                result[0] += (float)0.9207317073170732;
                result[1] += (float)0;
                result[2] += (float)0.07317073170731707;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.006097560975609756;
              }
            }
          } else {
            if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)49) ) ) {
              ...
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)111.5) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0034562211981566822;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)1;
          ...
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)100.5) ) ) {
            if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.5) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)33) ) ) {
                result[0] += (float)0.5670261941448382;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.43297380585516176;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
              ...
              if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)29.5) ) ) {
                result[0] += (float)0.628808864265928;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.37119113573407203;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)102) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)39.5) ) ) {
                ...
                result[0] += (float)0.9926663174436878;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.007333682556312206;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
        ...
        if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)40) ) ) {
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)99.5) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)19) ) ) {
              ...
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)91) ) ) {
                result[0] += (float)0.8498550724637681;
                result[1] += (float)0;
                result[2] += (float)0.0005797101449275362;
                result[3] += (float)0.14898550724637682;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0005797101449275362;
              } else {
                result[0] += (float)0.48058252427184467;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.5194174757281553;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            ...
            if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)105.5) ) ) {
              ...
              if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-56) ) ) {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)1;
                result[3] += (float)0;
                ...
                result[0] += (float)0.9370860927152318;
                result[1] += (float)0;
                result[2] += (float)0.033112582781456956;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.029801324503311258;
              }
            }
          }
        } else {
          if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)57.5) ) ) {
            if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)3) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)47.5) ) ) {
                ...
                result[3] += (float)0.9661016949152542;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)90) ) ) {
            if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)89) ) ) {
              ...
              if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)83.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.2545454545454545;
                result[4] += (float)0.7454545454545455;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)76.5) ) ) {
            ...
            if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.5) ) ) {
              if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)35) ) ) {
                ...
                result[0] += (float)0.9996881334788711;
                result[1] += (float)0;
                result[2] += (float)0.0003118665211289568;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)36.5) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)74) ) ) {
              if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)26.5) ) ) {
                result[0] += (float)0.0014803849000740194;
                result[1] += (float)0.0007401924500370097;
                result[2] += (float)0.009622501850481127;
                result[3] += (float)0.9844559585492229;
                result[4] += (float)0;
                result[5] += (float)0.0037009622501850484;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0.2727272727272727;
                result[2] += (float)0.6060606060606061;
            ...
            if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)91.5) ) ) {
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)54.5) ) ) {
                result[0] += (float)0.9992821249102656;
                result[1] += (float)0;
                result[2] += (float)0.0007178750897343862;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9915127309036446;
                result[1] += (float)0;
                result[2] += (float)0.0074887668497254116;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.000998502246630055;
              }
            } else {
              if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)93.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.007867132867132868;
                result[3] += (float)0.011363636363636364;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0017482517482517483;
              }
            }
          }
        } else {
          if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)12.5) ) ) {
            ...
            if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)8.5) ) ) {
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)63) ) ) {
                result[0] += (float)0.4539877300613497;
                result[1] += (float)0;
                result[2] += (float)0.07975460122699386;
                result[3] += (float)0.4662576687116564;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0.034031413612565446;
                result[2] += (float)0;
                result[3] += (float)0.9659685863874345;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)62) ) ) {
                result[0] += (float)0.4126984126984127;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.5873015873015873;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)50) ) ) {
            ...
            if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)32) ) ) {
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)55.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9973544973544973;
                result[4] += (float)0;
                result[5] += (float)0.0026455026455026454;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
              ...
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)79.5) ) ) {
                ...
                result[4] += (float)0.011904761904761904;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
          ...
          if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)4.5) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)37.5) ) ) {
                ...
                result[0] += (float)0.9998198198198198;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.00018018018018018018;
              }
            } else {
          ...
          if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)35) ) ) {
            if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)80) ) ) {
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)43) ) ) {
                result[0] += (float)0.9927599189110918;
                result[1] += (float)0.0017376194613379669;
                result[2] += (float)0.004923255140457573;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0005792064871126556;
              } else {
                result[0] += (float)0.8698630136986302;
                result[1] += (float)0;
                result[2] += (float)0.13013698630136986;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)91) ) ) {
              ...
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)35.5) ) ) {
                ...
                result[0] += (float)0.0026789131266743206;
                result[1] += (float)0;
                result[2] += (float)0.0019135093761959434;
                result[3] += (float)0.9954075774971297;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
          ...
          if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)45) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)43) ) ) {
              if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-190) ) ) {
                ...
                result[0] += (float)0.9930189834660135;
                result[1] += (float)0;
                result[2] += (float)0.003061849357011635;
                result[3] += (float)0.0028169014084507044;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0011022657685241886;
              }
            } else {
              result[0] += (float)0;
              result[1] += (float)0;
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)43.5) ) ) {
              if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-3.5) ) ) {
                ...
                result[0] += (float)0.30701754385964913;
                result[1] += (float)0;
                result[2] += (float)0;
    ...
    if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)26.5) ) ) {
      if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)8) ) ) {
        ...
        if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)48) ) ) {
          if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)103) ) ) {
            if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)68.5) ) ) {
              ...
              if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-2.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9829059829059829;
                result[4] += (float)0;
          ...
          if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)34) ) ) {
            result[0] += (float)1;
            result[1] += (float)0;
            result[2] += (float)0;
            result[3] += (float)0;
          ...
          if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)35) ) ) {
            if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)81.5) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)58.5) ) ) {
                result[0] += (float)0.9978331527627302;
                result[1] += (float)0;
                result[2] += (float)0.0010834236186348862;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0010834236186348862;
              } else {
                result[0] += (float)0.838655462184874;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.16134453781512606;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)-3) ) ) {
                result[0] += (float)0.7658536585365854;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.23414634146341465;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.013888888888888888;
                result[1] += (float)0;
          ...
          if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)85.5) ) ) {
            if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)36) ) ) {
              if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)80.5) ) ) {
                result[0] += (float)0.0029069767441860465;
                result[1] += (float)0;
                result[2] += (float)0.0188953488372093;
                result[3] += (float)0.9767441860465116;
                result[4] += (float)0.0014534883720930232;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
                result[1] += (float)0;
                result[2] += (float)0.05390835579514825;
                result[3] += (float)0.5902964959568733;
                result[4] += (float)0.3557951482479784;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            } else {
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)85.5) ) ) {
                result[0] += (float)0.9991364421416234;
                result[1] += (float)0;
                result[2] += (float)0.0008635578583765112;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)81) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)79.5) ) ) {
                result[0] += (float)0.3031578947368421;
                result[1] += (float)0.02736842105263158;
                result[2] += (float)0;
                result[3] += (float)0.6694736842105263;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.052805280528052806;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9471947194719472;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)-23) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.5934959349593496;
                result[4] += (float)0.4065040650406504;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0;
          ...
          if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)5) ) ) {
            ...
            if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-45.5) ) ) {
              ...
              if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)35) ) ) {
                ...
                result[4] += (float)0.017241379310344827;
          ...
          if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.5) ) ) {
            if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)80.5) ) ) {
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)25.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.13076923076923078;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9860810392824002;
                result[1] += (float)0.006804825239715435;
                result[2] += (float)0.006495515001546551;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0006186204763377668;
              }
            } else {
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)36.5) ) ) {
                result[0] += (float)0.9986007462686567;
                result[1] += (float)0;
                result[2] += (float)0.0013992537313432835;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
            ...
            if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)24.5) ) ) {
              if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-0.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.06756756756756757;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( LIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)0.5) ) ) {
                result[0] += (float)0.999868212967844;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.00013178703215603585;
              } else {
                result[0] += (float)0.9947698744769875;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.002092050209205021;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0031380753138075318;
              }
            }
          }
        }
          ...
          if ( LIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)194) ) ) {
            if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)98.5) ) ) {
              ...
              if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)3) ) ) {
                ...
                result[0] += (float)0.9853917662682603;
                result[1] += (float)0;
                result[2] += (float)0.006640106241699867;
                result[3] += (float)0.00796812749003984;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            ...
            if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)172) ) ) {
              result[0] += (float)0;
              result[1] += (float)0;
              result[2] += (float)1;
              result[3] += (float)0;
          ...
          if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)49) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)26) ) ) {
              ...
              if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-18.5) ) ) {
                ...
                result[0] += (float)0.0038022813688212928;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.9923954372623575;
                result[4] += (float)0;
                result[5] += (float)0.0038022813688212928;
                result[6] += (float)0;
              }
            }
          } else {
          ...
          if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)24.5) ) ) {
            ...
            if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)45.5) ) ) {
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)33.5) ) ) {
                ...
                result[0] += (float)0.9989602963155502;
                result[1] += (float)0.000259925921112483;
                result[2] += (float)0.000519851842224966;
                result[3] += (float)0.00019494444083436224;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)6.498148027812075e-05;
              }
            } else {
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)48.5) ) ) {
                result[0] += (float)0.9886299033541786;
                result[1] += (float)0.006822057987492893;
                result[2] += (float)0.0034110289937464467;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0011370096645821489;
              } else {
                result[0] += (float)0.9971131639722864;
                result[1] += (float)0;
                result[2] += (float)0.0025981524249422635;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.00028868360277136264;
              }
            }
          }
        }
          ...
          if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)36) ) ) {
            if ( UNLIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)-39) ) ) {
              ...
              if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)55.5) ) ) {
                ...
                result[0] += (float)0;
                result[1] += (float)0.0030432136335970784;
                result[2] += (float)0.005477784540474742;
                result[3] += (float)0.9914790018259282;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
      ...
      if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)99.5) ) ) {
        ...
        if ( LIKELY( !(data[2].missing != -1) || (data[2].fvalue <= (float)35) ) ) {
          if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)43) ) ) {
            ...
            if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)7) ) ) {
              if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.5) ) ) {
                result[0] += (float)0.8985507246376812;
                result[1] += (float)0;
                result[2] += (float)0.0821256038647343;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.01932367149758454;
              } else {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.00847457627118644;
              }
            } else {
              result[0] += (float)1;
              result[1] += (float)0;
          ...
          if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
            ...
            if ( UNLIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)4.5) ) ) {
              if ( UNLIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)1) ) ) {
                ...
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.05454545454545454;
              }
            } else {
              result[0] += (float)1;
              result[1] += (float)0;
          ...
          if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)37.5) ) ) {
            if ( UNLIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)33.5) ) ) {
              ...
              if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)35.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0.0020920502092050207;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
      ...
      if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)6) ) ) {
        ...
        if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-52.5) ) ) {
          ...
          if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)0.5) ) ) {
            if ( LIKELY( !(data[3].missing != -1) || (data[3].fvalue <= (float)-0.5) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)99.5) ) ) {
                result[0] += (float)0.015271493212669683;
                result[1] += (float)0.002828054298642534;
                result[2] += (float)0;
                result[3] += (float)0.9819004524886877;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
              ...
              if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)25.5) ) ) {
                ...
                result[3] += (float)0.9769452449567724;
                result[4] += (float)0;
                result[5] += (float)0.005763688760806916;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.0995850622406639;
                result[1] += (float)0.0995850622406639;
                result[2] += (float)0.05394190871369295;
                result[3] += (float)0.7468879668049793;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
            ...
            if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)36.5) ) ) {
              if ( LIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)99.5) ) ) {
                result[0] += (float)0;
                result[1] += (float)0.0006858710562414266;
                result[2] += (float)0;
                result[3] += (float)0.9993141289437586;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
          ...
          if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)87.5) ) ) {
            if ( LIKELY( !(data[6].missing != -1) || (data[6].fvalue <= (float)37) ) ) {
              if ( UNLIKELY( !(data[0].missing != -1) || (data[0].fvalue <= (float)78.5) ) ) {
                result[0] += (float)0.9917849141150112;
                result[1] += (float)0;
                result[2] += (float)0.006348020911127707;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.0018670649738610904;
              } else {
                result[0] += (float)0.9989915966386554;
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.0010084033613445378;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              }
              ...
              if ( UNLIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)39.5) ) ) {
                ...
                result[1] += (float)0;
                result[2] += (float)0;
                result[3] += (float)0.5588235294117647;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
              } else {
                result[0] += (float)0.9918478260869565;
                result[1] += (float)0;
                result[2] += (float)0.008152173913043478;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0;
          ...
          if ( LIKELY( !(data[5].missing != -1) || (data[5].fvalue <= (float)59.5) ) ) {
            ...
            if ( LIKELY( !(data[4].missing != -1) || (data[4].fvalue <= (float)74) ) ) {
              if ( UNLIKELY( !(data[1].missing != -1) || (data[1].fvalue <= (float)-61) ) ) {
                ...
                result[0] += (float)0.9873843566021867;
                result[1] += (float)0;
                result[2] += (float)0.010933557611438183;
                result[3] += (float)0;
                result[4] += (float)0;
                result[5] += (float)0;
                result[6] += (float)0.001682085786375105;
              }
            } else {
              result[0] += (float)0;
              result[1] += (float)0;
